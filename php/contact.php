...
if (!validarVariable($personas)  || !validarVariable($fecha) || !validarVariable($nombre) || !validarVariable($tel)) {
  mandarError("1");
}

$correo_nuevo = new Correo("patobuzo@outlook.com", $nombre.' ha enviado un nuevo mensaje');
$correo_nuevo->agregarCampos("Nombre: ", $nombre);
$correo_nuevo->agregarCampos("Teléfono: ", $tel);
$correo_nuevo->agregarCampos("Cantidad de personas: ", $personas);
$correo_nuevo->agregarCampos("Fecha y hora: ", $fecha);
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                        <tr>
                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Has recibido unam nueva reservación</p>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                  <tr>
                    <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                      <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Copyright © 2023 Pato Buzo. Todos los Derechos Reservados.</span>

...
if (
  ((function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ? t(exports, require("jquery"), require("popper.html"))
      ...
      T = (function () {
        ...
        return (
          ...
          (e._jQueryInterface = function (i) {
            return this.each(function () {
              var n = t(this).data(m);
              n || ((n = new e(this)), t(this).data(m, n)),
                "toggle" === i && n[i]();
            });
          }),
          s(e, null, [
    ...
    t(document)
      .on(w.CLICK_DATA_API, y, function (e) {
        e.preventDefault();
        var i = e.target;
        t(i).hasClass("btn") || (i = t(i).closest(k)),
          T._jQueryInterface.call(t(i), "toggle");
      })
      ...
      (t.fn[p].noConflict = function () {
        return (t.fn[p] = _), T._jQueryInterface;
      });
    var x = "carousel",
      S = "bs.carousel",
      C = "." + S,
      ...
      F = (function () {
        ...
        return (
          ...
          (i._getConfig = function (e) {
            return (e = o({}, P, e)), a.typeCheckConfig(x, e, j), e;
          }),
          ...
          (i._getItemByDirection = function (e, t) {
            ...
            if (((n && 0 === s) || (i && s === o)) && !this._config.wrap)
              return t;
            var r = (s + (e === E ? -1 : 1)) % this._items.length;
            return -1 === r
          ...
          (e._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (n || ((n = new e(this, s)), t(this).data(S, n)),
                "number" == typeof i)
              )
                n.to(i);
    ...
    t(document).on(
      ...
      (t.fn[x] = F._jQueryInterface),
      (t.fn[x].Constructor = F),
      (t.fn[x].noConflict = function () {
        return (t.fn[x] = O), F._jQueryInterface;
      });
    var $ = "collapse",
      R = "bs.collapse",
      N = "." + R,
      ...
      K = (function () {
        function e(e, t) {
          ...
          for (
            var i = [].slice.call(document.querySelectorAll(V)),
              n = 0,
              s = i.length;
            n < s;
            n++
        ...
        return (
            ...
            if (
              !(
                ...
                (this._parent &&
                  ...
                  (i = null),
                i &&
                  (n = t(i).not(this._selector).data(R)) &&
                  n._isTransitioning)
              )
            ) {
              ...
              if ((t(this._element).trigger(o), !o.isDefaultPrevented())) {
                i &&
                  (e._jQueryInterface.call(t(i).not(this._selector), "hide"),
                  n || t(i).data(R, null));
                var r = this._getDimension();
                t(this._element).removeClass(U).addClass(G),
                ...
                t(this._element)
                  .one(a.TRANSITION_END, function () {
                    t(s._element).removeClass(G).addClass(U).addClass(Y),
                      (s._element.style[r] = ""),
                      s.setTransitioning(!1),
                      t(s._element).trigger(B.SHOWN);
                  })
            ...
            if (!this._isTransitioning && t(this._element).hasClass(Y)) {
              ...
              if ((t(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                (this._element.style[n] =
                  ...
                  t(this._element).addClass(G).removeClass(U).removeClass(Y);
                  ...
                  for (var o = 0; o < s; o++) {
                    ...
                    null !== l &&
                      (t([].slice.call(document.querySelectorAll(l))).hasClass(
                        ...
                        t(r).addClass(X).attr("aria-expanded", !1));
                  }
          ...
          (i._getConfig = function (e) {
            return (
              ((e = o({}, q, e)).toggle = Boolean(e.toggle)),
              a.typeCheckConfig($, e, H),
              e
            );
          }),
          (i._getDimension = function () {
            return t(this._element).hasClass(J) ? J : "height";
          }),
          ...
          (e._jQueryInterface = function (i) {
            return this.each(function () {
              var n = t(this),
                s = n.data(R),
                r = o({}, q, n.data(), "object" == typeof i && i ? i : {});
              if (
                (!s && r.toggle && /show|hide/.test(i) && (r.toggle = !1),
                s || ((s = new e(this, r)), n.data(R, s)),
                "string" == typeof i)
              ) {
                if (void 0 === s[i])
    ...
    t(document).on(B.CLICK_DATA_API, V, function (e) {
        ...
        return (
            ...
            if (
              ...
              t(s).trigger(n),
                n.isDefaultPrevented() ||
                  (t(this._menu).toggleClass(re),
                  t(s).toggleClass(re).trigger(t.Event(se.SHOWN, i)));
            }
          }),
          (n.hide = function () {
            if (
              ...
              t(s).trigger(n),
                n.isDefaultPrevented() ||
                  (t(this._menu).toggleClass(re),
                  t(s).toggleClass(re).trigger(t.Event(se.HIDDEN, i)));
            }
          }),
          (n.dispose = function () {
          ...
          (n._getConfig = function (e) {
            return (
              ...
              a.typeCheckConfig(Q, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (n._getPlacement = function () {
            ...
            return (
              e.hasClass("dropup")
                ? ((i = "top-start"),
                  t(this._menu).hasClass(ae) && (i = "top-end"))
                : e.hasClass("dropright")
                ? (i = "right-start")
                : e.hasClass("dropleft")
                ? (i = "left-start")
                : t(this._menu).hasClass(ae) && (i = "bottom-end"),
              i
            );
          }),
          ...
          (e._clearMenus = function (i) {
            if (!i || (3 !== i.which && ("keyup" !== i.type || 9 === i.which)))
              for (
                var n = [].slice.call(document.querySelectorAll(le)),
                  s = 0,
                  o = n.length;
                s < o;
                s++
                  ...
                  if (
                    ...
                    t(r).trigger(d),
                      d.isDefaultPrevented() ||
                        ...
                        t(c).removeClass(re),
                        t(r).removeClass(re).trigger(t.Event(se.HIDDEN, l)));
                  }
                }
              }
          }),
    ...
    t(document)
      .on(se.KEYDOWN_DATA_API, le, fe._dataApiKeydownHandler)
      .on(se.KEYDOWN_DATA_API, ce, fe._dataApiKeydownHandler)
      .on(se.CLICK_DATA_API + " " + se.KEYUP_DATA_API, fe._clearMenus)
      .on(se.CLICK_DATA_API, le, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
          fe._jQueryInterface.call(t(this), "toggle");
      })
      .on(se.CLICK_DATA_API, ".dropdown form", function (e) {
        e.stopPropagation();
      }),
      (t.fn[Q] = fe._jQueryInterface),
      (t.fn[Q].Constructor = fe),
      (t.fn[Q].noConflict = function () {
        return (t.fn[Q] = ie), fe._jQueryInterface;
      });
    var he = "modal",
      pe = "bs.modal",
      me = "." + pe,
        ...
        return (
          ...
          (i.show = function (e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
              ...
              var n = t.Event(be.SHOW, { relatedTarget: e });
          ...
          (i.hide = function (e) {
            ...
            if (
              ...
              if (
                ...
                this._isShown = !1;
                var s = t(this._element).hasClass(ke);
                if (
                  (s && (this._isTransitioning = !0),
                  this._setEscapeEvent(),
                  this._setResizeEvent(),
                  t(document).off(be.FOCUSIN),
                  t(this._element).removeClass(we),
          ...
          (i._getConfig = function (e) {
            return (e = o({}, ve, e)), a.typeCheckConfig(he, e, _e), e;
          }),
          (i._showElement = function (e) {
            var i = this,
              n = t(this._element).hasClass(ke);
            (this._element.parentNode &&
              ...
              t(this._element).addClass(we),
              this._config.focus && this._enforceFocus();
            var s = t.Event(be.SHOWN, { relatedTarget: e }),
              o = function () {
            ...
            if (n) {
              ...
              t(this._dialog).one(a.TRANSITION_END, o).emulateTransitionEnd(r);
            } else o();
          }),
          ...
          (i._showBackdrop = function (e) {
            var i = this,
              n = t(this._element).hasClass(ke) ? ke : "";
          ...
          (i._setScrollbar = function () {
            ...
            if (this._isBodyOverflowing) {
              var i = [].slice.call(document.querySelectorAll(Te)),
                n = [].slice.call(document.querySelectorAll(xe));
          ...
          (e._jQueryInterface = function (i, n) {
            return this.each(function () {
              ...
              if (
                (s || ((s = new e(this, r)), t(this).data(pe, s)),
                "string" == typeof i)
              ) {
                if (void 0 === s[i])
                  throw new TypeError('No method named "' + i + '"');
    ...
    t(document).on(be.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
      ...
      var r = t(i).data(pe) ? "toggle" : o({}, t(i).data(), t(this).data());
      ...
      (t.fn[he].noConflict = function () {
        return (t.fn[he] = ge), Se._jQueryInterface;
      });
    var Ce = [
        "background",
        "cite",
      ...
      Ge = (function () {
        ...
        return (
          ...
          (n.toggle = function (e) {
            if (this._isEnabled)
              if (e) {
                ...
                if (t(this.getTipElement()).hasClass(Be))
          ...
          (n.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              r.setAttribute("id", l),
                ...
                this.setContent(),
                this.config.animation && t(r).addClass(He);
              var c =
          ...
          (n.addAttachmentClass = function (e) {
            t(this.getTipElement()).addClass(Ie + "-" + e);
          }),
          ...
          (n.setContent = function () {
            ...
            this.setElementContent(
              ...
              t(e).removeClass(He + " " + Be);
          }),
          (n.setElementContent = function (e, i) {
            "object" != typeof i || (!i.nodeType && !i.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (i = Pe(i, this.config.whiteList, this.config.sanitizeFn)),
                  e.html(i))
                : e.text(i)
              : this.config.html
          ...
          (n._enter = function (e, i) {
            ...
            (i = i || t(e.currentTarget).data(n)) ||
              ...
              e && (i._activeTrigger["focusin" === e.type ? Ue : Ye] = !0),
              t(i.getTipElement()).hasClass(Be) || i._hoverState === Ne
                ? (i._hoverState = Ne)
                : (clearTimeout(i._timeout),
                  (i._hoverState = Ne),
                  i.config.delay && i.config.delay.show
                    ? (i._timeout = setTimeout(function () {
                        i._hoverState === Ne && i.show();
                      }, i.config.delay.show))
                    : i.show());
          }),
          (n._leave = function (e, i) {
            ...
            (i = i || t(e.currentTarget).data(n)) ||
              ...
              t(e.currentTarget).data(n, i)),
              e && (i._activeTrigger["focusout" === e.type ? Ue : Ye] = !1),
              i._isWithActiveTrigger() ||
                (clearTimeout(i._timeout),
                (i._hoverState = We),
                i.config.delay && i.config.delay.hide
                  ? (i._timeout = setTimeout(function () {
                      i._hoverState === We && i.hide();
                    }, i.config.delay.hide))
                  : i.hide());
          }),
          ...
          (n._getConfig = function (e) {
            ...
            return (
              ...
              a.typeCheckConfig(je, e, this.constructor.DefaultType),
              e.sanitize &&
                (e.template = Pe(e.template, e.whiteList, e.sanitizeFn)),
              e
            );
          }),
          ...
          (e._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                ...
                (n || ((n = new e(this, s)), t(this).data(Ae, n)),
                "string" == typeof i)
              ) {
                if (void 0 === n[i])
                  throw new TypeError('No method named "' + i + '"');
    ...
    var Xe = "popover",
      ...
      tt = o({}, Ge.DefaultType, { content: "(string|element|function)" }),
      it = {
        HIDE: "hide" + Ve,
        HIDDEN: "hidden" + Ve,
        SHOW: "show" + Ve,
          ...
          (o._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (i || ((i = new o(this, n)), t(this).data(Je, i)),
                "string" == typeof e)
              ) {
                if (void 0 === i[e])
    ...
    (t.fn[Xe] = nt._jQueryInterface),
      (t.fn[Xe].Constructor = nt),
      (t.fn[Xe].noConflict = function () {
        return (t.fn[Xe] = Ke), nt._jQueryInterface;
      });
    var st = "scrollspy",
      ot = "bs.scrollspy",
      rt = "." + ot,
      ...
      gt = (function () {
        ...
        return (
          ...
          (i._getConfig = function (e) {
            if (
              "string" !=
              typeof (e = o({}, lt, "object" == typeof e && e ? e : {})).target
            ) {
              var i = t(e.target).attr("id");
              i || ((i = a.getUID(st)), t(e.target).attr("id", i)),
                (e.target = "#" + i);
            }
          ...
          (i._activate = function (e) {
            ...
            n.hasClass("dropdown-item")
              ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(ut),
                n.addClass(ut))
              : (n.addClass(ut),
                n
                  .parents(ft)
                  .prev(ht + ", " + pt)
                  .addClass(ut),
                n.parents(ft).prev(".nav-item").children(ht).addClass(ut)),
    ...
    t(window).on(dt.LOAD_DATA_API, function () {
      ...
      (t.fn[st] = gt._jQueryInterface),
      (t.fn[st].Constructor = gt),
      (t.fn[st].noConflict = function () {
        return (t.fn[st] = at), gt._jQueryInterface;
      });
    var vt = "bs.tab",
      _t = "." + vt,
      bt = t.fn.tab,
        ...
        return (
          (i.show = function () {
            ...
            if (
              ...
              if (s) {
                var r = "UL" === s.nodeName || "OL" === s.nodeName ? St : xt;
                n = (n = t.makeArray(t(s).find(r)))[n.length - 1];
              }
              var l = t.Event(yt.HIDE, { relatedTarget: this._element }),
                c = t.Event(yt.SHOW, { relatedTarget: n });
              if (
                (n && t(n).trigger(l),
                ...
                var d = function () {
                  var i = t.Event(yt.HIDDEN, { relatedTarget: e._element }),
                    s = t.Event(yt.SHOWN, { relatedTarget: n });
          ...
          (i._transitionComplete = function (e, i, n) {
            ...
            if (
              ...
              a.reflow(e),
              e.classList.contains(wt) && e.classList.add(Tt),
          ...
          (e._jQueryInterface = function (i) {
            return this.each(function () {
              var n = t(this),
                s = n.data(vt);
              if (
                (s || ((s = new e(this)), n.data(vt, s)), "string" == typeof i)
              ) {
                if (void 0 === s[i])
                  throw new TypeError('No method named "' + i + '"');
                s[i]();
    ...
    var Dt = "toast",
      ...
      Ft = (function () {
        ...
        return (
          (i.show = function () {
            var e = this;
            t(this._element).trigger(At.SHOW),
              this._config.animation && this._element.classList.add("fade");
            var i = function () {
              e._element.classList.remove(It),
                e._element.classList.add(Mt),
                t(e._element).trigger(At.SHOWN),
          ...
          (i.hide = function (e) {
            ...
            this._element.classList.contains(Mt) &&
              (t(this._element).trigger(At.HIDE),
              e
                ? this._close()
          ...
          (i._getConfig = function (e) {
            return (
              ...
              a.typeCheckConfig(Dt, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (i._close = function () {
            var e = this,
              i = function () {
                e._element.classList.add(Et), t(e._element).trigger(At.HIDDEN);
              };
          ...
          (e._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (s ||
                  ((s = new e(this, "object" == typeof i && i)), n.data(Ot, s)),
                "string" == typeof i)
              ) {
                if (void 0 === s[i])
                  throw new TypeError('No method named "' + i + '"');
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  "use strict";
  var e, t, i, n, s, o, r, a, l, c, d, u, f, h, p, m;
  _gsScope._gsDefine(
    "TweenMax",
    ...
    function (e, t, i) {
          ...
          return function (e, c, d) {
            ...
            if (!k) {
              if (!(b = "auto" === t.grid ? 0 : (t.grid || [1 / 0])[0])) {
                for (
                  v = -1 / 0;
                  v < (v = d[b++].getBoundingClientRect().left) && y > b;
              ...
              for (
                ...
                (h = (g % b) - u),
                  (p = f - ((g / b) | 0)),
                  (k[g] = m =
                    a ? Math.abs("y" === a ? p : h) : Math.sqrt(h * h + p * p)),
                  m > v && (v = m),
                  _ > m && (_ = m);
              (k.max = v - _),
                (k.min = _),
            ...
            return (
              (y = (k[e] - k.min) / k.max), k.b + (i ? i.getRatio(y) : y) * k.v
            );
          };
        },
        r = function (e, t, n) {
      ...
      (r.version = "2.1.3"),
        ...
        (u.updateTo = function (e, t) {
          var n,
            s = this,
            o = s.ratio,
            r = s.vars.immediateRender || e.immediateRender;
          for (n in (t &&
          ...
          e))
            s.vars[n] = e[n];
          if (s._initted || r)
            if (t) (s._initted = !1), r && s.render(0, !0, !0);
            else if (
            ...
            } else if (((s._initted = !1), s._init(), s._time > 0 || r))
              for (var l, c = 1 / (1 - o), d = s._firstPT; d; )
          ...
          if (
              ...
              ? ((m._totalTime = g),
                ...
                0 === y &&
                  ...
                  (0 > k ||
                    ...
                    (k === a && "isPause" !== m.data)) &&
                    k !== e &&
                    ((n = !0), k > a && (o = "onReverseComplete")),
                  (m._rawPrevTime = h = !t || e || k === e ? e : a)))
              : a > e
              ? ((m._totalTime = m._time = m._cycle = 0),
                (m.ratio = m._ease._calcEnd ? m._ease.getRatio(0) : 0),
                (0 !== _ || (0 === y && k > 0)) &&
                  ((o = "onReverseComplete"), (s = m._reversed)),
                e > -a
                  ? (e = 0)
                  : 0 > e &&
                    ((m._active = !1),
                          ...
                          : ((p = m.vars.ease),
                            (m._yoyoEase = p =
                              p
                                ...
                                : i.defaultEase))),
                      (m.ratio = p ? 1 - p.getRatio((y - m._time) / y) : 0))),
                  m._time > y ? (m._time = y) : m._time < 0 && (m._time = 0)),
                m._easeType && !p
                  ? ((d = m._time / y),
                    (1 === (u = m._easeType) || (3 === u && d >= 0.5)) &&
                      (d = 1 - d),
                    3 === u && (d *= 2),
                    1 === (f = m._easePower)
                      ? (d *= d)
                    ...
                    (m.ratio =
                      1 === u
                        ...
                        ? d / 2
                        : 1 - d / 2))
                  : p || (m.ratio = m._ease.getRatio(m._time / y))),
            ...
            if (!m._initted) {
              ...
              !m._time || s || p
                ...
                : (m.ratio = m._ease.getRatio(m._time / y));
            }
            for (
              !1 !== m._lazy && (m._lazy = !1),
                m._active ||
                  (!m._paused && m._time !== v && e >= 0 && (m._active = !0)),
                0 === _ &&
            ...
            m._onUpdate &&
              (0 > e &&
                ...
                m._startTime &&
                m._startAt.render(e, !0, n),
              t || ((m._totalTime !== _ || o) && m._callback("onUpdate"))),
              m._cycle !== b &&
            ...
            _ !== m._totalTime && m._onUpdate && (t || m._callback("onUpdate"));
        }),
        (r.to = function (e, t, i) {
          return new r(e, t, i);
        }),
          ...
          function (e, t, a, l, u, h, p) {
            ...
            for (
              ...
              if (
                ...
                for (_ in ((w = g.startAt = {}), a.startAt))
                  w[_] = a.startAt[_];
                s(g.startAt, e, v);
              }
              (g.delay = y(v, e[v], e) + (g.delay || 0)),
                v === m &&
                  u &&
        ...
        (r.staggerFrom = r.allFrom =
          function (e, t, i, n, s, o, a) {
            return (
              (i.runBackwards = !0),
              (i.immediateRender = 0 != i.immediateRender),
              r.staggerTo(e, t, i, n, s, o, a)
            );
          }),
        (r.staggerFromTo = r.allFromTo =
          function (e, t, i, n, s, o, a, l) {
            return (
              (n.startAt = i),
              (n.immediateRender =
                0 != n.immediateRender && 0 != i.immediateRender),
              r.staggerTo(e, t, n, s, o, a, l)
            );
          }),
      ...
      var h = function (e, t) {
          for (var n = [], s = 0, o = e._first; o; )
            o instanceof i
              ? (n[s++] = o)
              : (t && (n[s++] = o), (s = (n = n.concat(h(o, t))).length)),
              (o = o._next);
          return n;
        },
        ...
        (r.killChildTweensOf = function (e, t) {
          if (null != e) {
            ...
            if (
              ...
              for (a in ((s = []), h))
                for (o = h[a].target.parentNode; o; )
                  o === e && (s = s.concat(h[a].tweens)), (o = o.parentNode);
              for (f = s.length, u = 0; f > u; u++)
                t && s[u].totalTime(s[u].totalDuration()),
                  s[u]._enabled(!1, !1);
            }
          }
        });
      ...
      function (e, t, i) {
        var n = function (e) {
            ...
            var i,
              ...
              o = s.vars;
            for (n in ((s._labels = {}),
            (s.autoRemoveChildren = !!o.autoRemoveChildren),
            (s.smoothChildTiming = !!o.smoothChildTiming),
            (s._sortChildren = !0),
            (s._onUpdate = o.onUpdate),
            o))
              (i = o[n]),
                l(i) &&
                  -1 !== i.join("").indexOf("{self}") &&
                  (o[n] = s._swapSelfInParams(i));
            l(o.tweens) && s.add(o.tweens, 0, o.align, o.stagger);
          },
          s = 1e-8,
          o = i._internals,
          r = (n._internals = {}),
        ...
        return (
          ...
          (v.from = function (e, t, n, s) {
            return this.add(
              ((n.repeat && u.TweenMax) || i).from(e, t, m(0, n)),
              s
            );
          }),
          (v.fromTo = function (e, t, n, s, o) {
            var r = (s.repeat && u.TweenMax) || i;
            return (
              (s = m(0, s, n)),
              t ? this.add(r.fromTo(e, t, n, s), o) : this.set(e, s, o)
            );
          }),
          (v.staggerTo = function (e, t, s, o, r, l, c, d) {
            var u,
              p,
              m = new n({
                onComplete: l,
            ...
            for (
              ...
              (u = f(s)),
                _ && ((u.startAt = f(_)), _.cycle && h(u.startAt, e, p)),
                b &&
                  (h(u, e, p),
                  null != u.duration && ((t = u.duration), delete u.duration)),
                m.to(e[p], t, u, v(p, e[p], e));
            return this.add(m, r);
          }),
          (v.staggerFrom = function (e, t, i, n, s, o, r, a) {
            return (
              (i.runBackwards = !0),
              this.staggerTo(e, t, m(0, i), n, s, o, r, a)
            );
          }),
          (v.staggerFromTo = function (e, t, i, n, s, o, r, a, l) {
            return (
              (n.startAt = i), this.staggerTo(e, t, m(0, n, i), s, o, r, a, l)
            );
          }),
            ...
            for (
              ...
              (a = r._next),
                (t && r instanceof i && r.target === r.vars.onComplete) ||
                  (0 > (o = r._startTime - r._delay) && (s = 1), l.add(r, o)),
                (r = a);
            return c.add(l, 0), s && l.totalDuration(), l;
          }),
          (v.add = function (s, o, r, a) {
            var c,
              d,
              u,
              f,
              ...
              m = this;
            if (
              ("number" != typeof o && (o = m._parseTimeOrLabel(o, 0, !0, s)),
              !(s instanceof e))
            ) {
              if (s instanceof Array || (s && s.push && l(s))) {
                for (
                  r = r || "normal", a = a || 0, c = o, d = s.length, u = 0;
                  d > u;
                  u++
                )
                  l((f = s[u])) && (f = new n({ tweens: f })),
                    m.add(f, c),
                    "string" != typeof f &&
                      "function" != typeof f &&
                      ("sequence" === r
                        ? (c = f._startTime + f.totalDuration() / f._timeScale)
                        : "start" === r && (f._startTime -= f.delay())),
                    (c += a);
                return m._uncache(!0);
              }
              if ("string" == typeof s) return m.addLabel(s, o);
            ...
            if (
              (t.prototype.add.call(m, s, o),
              (s._time || (!s._duration && s._initted)) &&
                ((c = (m.rawTime() - s._startTime) * s._timeScale),
                (!s._duration ||
                  Math.abs(Math.max(0, Math.min(s.totalDuration(), c))) -
                    s._totalTime >
                    1e-5) &&
                  s.render(c, !1, !1)),
              ...
              for (p = (h = m).rawTime() > s._startTime; h._timeline; )
          ...
          (v._parseTimeOrLabel = function (t, i, n, s) {
            ...
            if (
              ...
              (i =
                ...
                (t =
                  r > 1 ? this._parseTimeOrLabel(t.substr(0, r - 1), 0, n) : o);
            }
            return Number(t) + i;
          }),
          (v.seek = function (e, t) {
          ...
          (v.render = function (e, t, i) {
            ...
            if (
              ...
              if (e > m)
                for (n = p._first; n && n._startTime <= e && !u; )
                  n._duration ||
                    "isPause" !== n.data ||
                    n.ratio ||
                ...
                for (n = p._last; n && n._startTime >= e && !u; )
                  n._duration ||
                    ("isPause" === n.data && n._rawPrevTime > 0 && (u = n)),
                    (n = n._prev);
              u &&
                ((p._time = p._totalTime = e = u._startTime),
                (h =
                  p._startTime +
            ...
            if (e >= g - s && e >= 0)
              ...
              if (
                ...
                (0 !== m ||
                  ...
                  ((a = "onReverseComplete"), (o = p._reversed)),
                0 > e)
              )
                (p._active = !1),
            ...
            if ((p._time !== m && p._first) || i || l || u) {
              if (
                ...
                for (
                  n = p._first;
                  n && ((r = n._next), f === p._time && (!p._paused || b));

                )
                  (n._active || (n._startTime <= f && !n._paused && !n._gc)) &&
                    (u === n && (p.pause(), (p._pauseTime = h)),
                    n._reversed
                      ? n.render(
                ...
                for (
                  n = p._last;
                  n && ((r = n._prev), f === p._time && (!p._paused || b));
                  ...
                  if (
                    ...
                    if (u === n) {
                      for (u = n._prev; u && u.endTime() > p._time; )
                        u.render(
                          u._reversed
                            ? u.totalDuration() -
              ...
              p._onUpdate && (t || (c.length && d(), p._callback("onUpdate"))),
                a &&
                  (p._gc ||
                    ((v === p._startTime || _ !== p._timeScale) &&
            ...
            for (var o = [], r = this._first, a = 0; r; )
              r._startTime < s ||
                (r instanceof i
                  ...
                  : (!1 !== n && (o[a++] = r),
                    !1 !== e &&
                      (a = (o = o.concat(r.getChildren(!0, t, n))).length))),
                (r = r._next);
            return o;
          }),
          (v.getTweensOf = function (e, t) {
            var n,
              ...
              a = 0;
            for (
              o && this._enabled(!0, !0), s = (n = i.getTweensOf(e)).length;
              --s > -1;
          ...
          (v.totalDuration = function (e) {
            if (!arguments.length) {
              if (this._dirty) {
                for (
                  var t, i, n = 0, s = this, o = s._last, r = 999999999999;
                  o;
                  ...
                  (t = o._prev),
                    ...
                    o._startTime < 0 &&
                      ...
                      s._timeline.smoothChildTiming &&
                        ((s._startTime += o._startTime / s._timeScale),
                        (s._time -= o._startTime),
                        (s._totalTime -= o._startTime),
                        (s._rawPrevTime -= o._startTime)),
                      s.shiftChildren(-o._startTime, !1, -9999999999),
                      (r = 0)),
        ...
        return (
          ...
          (d.render = function (e, t, i) {
            ...
            var n,
              ...
              T = m._paused,
              x = m._cycle;
            if ((g !== m._time && (e += m._time - g), e >= v - s && e >= 0))
              ...
              if (
                ...
                (0 !== g ||
                  (0 === _ &&
                    ...
                    (w > 0 || (0 > e && w >= 0)) &&
                    !m._locked)) &&
                  ((c = "onReverseComplete"), (o = m._reversed)),
                0 > e)
              )
                (m._active = !1),
            ...
            if (m._hasPause && !m._forcingPlayhead && !t) {
              if ((e = m._time) > g || (m._repeat && x !== m._cycle))
              ...
              f &&
                ((p =
                  m._startTime +
                  (m._reversed ? m._duration - f._startTime : f._startTime) /
                    m._timeScale),
                f._startTime < _ &&
                  ((m._time = m._rawPrevTime = e = f._startTime),
                  (m._totalTime =
                    e + m._cycle * (m._totalDuration + m._repeatDelay))));
            }
            if (m._cycle !== x && !m._locked) {
              var S = m._yoyo && 0 != (1 & x),
              ...
              if (
                ((m._totalTime = x * _),
                m._cycle < x ? (S = !S) : (m._totalTime += _),
                (m._time = g),
                (m._rawPrevTime = 0 === _ ? w - 1e-4 : w),
                (m._cycle = x),
                (m._locked = !0),
                (g = S ? 0 : _),
                m.render(g, t, 0 === _),
            ...
            if ((m._time !== g && m._first) || i || d || f) {
              if (
                ...
                for (
                  n = m._first;
                  n && ((l = n._next), h === m._time && (!m._paused || T));
                ...
                for (
                  n = m._last;
                  n && ((l = n._prev), h === m._time && (!m._paused || T));
    ...
    (l = function (e, s, o, r, l) {
      ...
      for (c = 0; w > c; c++)
        (d = (h = e[T]).a),
          ...
          l
            ? ((b = t[c]),
              (k = (((y = i[c]) + b) * s * 0.25) / (r ? 0.5 : n[c] || 0.5)),
              (g =
                u -
                ((p = u - (u - d) * (r ? 0.5 * s : 0 !== b ? k / b : 0)) +
                  ((((m = u + (f - u) * (r ? 0.5 * s : 0 !== y ? k / y : 0)) -
                    p) *
                    ((3 * b) / (b + y) + 0.5)) /
                    4 || 0))))
            : (g =
                u -
                ((p = u - (u - d) * s * 0.5) + (m = u + (f - u) * s * 0.5)) /
                  2),
          (p += g),
          (m += g),
          (h.c = v = p),
          (h.b = 0 !== c ? x : (x = h.a + 0.6 * (h.c - h.a))),
          (h.da = u - d),
          (h.ca = v - d),
          (h.ba = x - d),
          o
      ...
      ((h = e[T]).b = x),
        ...
        (h.ba = x - h.a),
        o &&
          ((_ = a(h.a, x, h.c, h.d)), e.splice(T, 1, _[0], _[1], _[2], _[3]));
    }),
    (c = function (e, n, s, o) {
      var a,
        l,
      ...
      if (o)
        for (l = (e = [o].concat(e)).length; --l > -1; )
          "string" == typeof (f = e[l][n]) &&
            "=" === f.charAt(1) &&
            (e[l][n] = o[n] + Number(f.charAt(0) + f.substr(2)));
      if (0 > (a = e.length - 2))
        return (h[0] = new r(e[0][n], 0, 0, e[0][n])), h;
      for (l = 0; a > l; l++)
        (c = e[l][n]),
          (d = e[l + 1][n]),
          (h[l] = new r(c, 0, 0, d)),
          s &&
            ...
            (t[l] = (t[l] || 0) + (d - c) * (d - c)),
            (i[l] = (i[l] || 0) + (u - d) * (u - d)));
      return (h[l] = new r(e[l][n], 0, 0, e[l + 1][n])), h;
    }),
    (d = function (e, o, r, a, d, u) {
      var f,
        h,
        p,
        m,
      ...
      e[0]))
        k.push(h);
      if (e.length > 1) {
        for (b = e[e.length - 1], _ = !0, f = k.length; --f > -1; )
          if (((h = k[f]), Math.abs(w[h] - b[h]) > 0.05)) {
            _ = !1;
            break;
          }
        _ &&
      ...
      for (t.length = i.length = n.length = 0, f = k.length; --f > -1; )
        (h = k[f]),
          (s[h] = -1 !== d.indexOf("," + h + ",")),
          (y[h] = c(e, h, s[h], u));
      for (f = t.length; --f > -1; )
      ...
      if (!a) {
        for (f = k.length; --f > -1; )
          if (s[h])
            for (v = (p = y[k[f]]).length - 1, m = 0; v > m; m++)
              (g = p[m + 1].da / i[m] + p[m].da / t[m] || 0),
                (n[m] = (n[m] || 0) + g * g);
        for (f = n.length; --f > -1; ) n[f] = Math.sqrt(n[f]);
      }
      for (f = k.length, m = r ? 4 : 1; --f > -1; )
        (p = y[(h = k[f])]),
          l(p, o, r, a, s[h]),
          _ && (p.splice(0, m), p.splice(p.length - m, m));
      return y;
    }),
    (u = function (e, t, i) {
      var n,
      ...
      for (c = _.length; --c > -1; ) {
        for (m[(f = _[c])] = l = [], h = 0, u = e.length, d = 0; u > d; d++)
          (n =
            null == i
              ? e[d][f]
              : "string" == typeof (p = e[d][f]) && "=" === p.charAt(1)
              ? i[f] + Number(p.charAt(0) + p.substr(2))
              : Number(p)),
            v && d > 1 && u - 1 > d && (l[h++] = (n + l[h - 2]) / 2),
            (l[h++] = n);
        for (u = h - g + 1, h = 0, d = 0; u > d; d += g)
          (n = l[d]),
            (s = l[d + 1]),
            (o = l[d + 2]),
            (a = 2 === g ? 0 : l[d + 3]),
    ...
    (f = function (e, t, i) {
      for (
        var n, s, o, r, a, l, c, d, u, f, h, p = 1 / i, m = e.length;
        --m > -1;
      ...
      set: function (t) {
        ...
        if (this._timeRes) {
          if (
            ...
            for (c = h - 1; c > s && (this._l2 = d[++s]) <= f; );
            (this._l1 = d[s - 1]),
              (this._li = s),
              (this._curSeg = u = this._segments[s]),
              (this._s2 = u[(this._s1 = this._si = 0)]);
          } else if (f < this._l1 && s > 0) {
            for (; s > 0 && (this._l1 = d[--s]) >= f; );
            0 === s && f < this._l1 ? (this._l1 = 0) : s++,
              (this._l2 = d[s]),
              (this._li = s),
              (this._curSeg = u = this._segments[s]),
          ...
          if (
            ...
            (f -= this._l1),
            (s = this._si),
            f > this._s2 && s < u.length - 1)
          ) {
            for (c = u.length - 1; c > s && (this._s2 = u[++s]) <= f; );
            (this._s1 = u[s - 1]), (this._si = s);
          } else if (f < this._s1 && s > 0) {
            for (; s > 0 && (this._s1 = u[--s]) >= f; );
            0 === s && f < this._s1 ? (this._s1 = 0) : s++,
              (this._s2 = u[s]),
              (this._si = s);
          }
          a =
            1 === t
              ? 1
              : (s + (f - this._s1) / (this._s2 - this._s1)) * this._prec || 0;
        } else
          a =
          ...
          for (s = x.length; --s > -1; )
            (o = x[s][2]),
              ...
              r &&
                ...
                (y += (r.c + (r.d - r.c) * a - y) * a),
                (b = v.a + (v.b - v.a) * a),
                (b += ((k = v.b + (v.c - v.b) * a) - b) * a),
                (k += (v.c + (v.d - v.c) * a - k) * a),
                (l = g
                  ? Math.atan2(k - b, y - _) * T + w
      ...
      if (e) {
        ...
        t._registerComplexSpecialProp("bezier", {
          parser: function (e, t, o, r, a, l) {
            ...
            if (0 > h) return a;
            for (c = 0; h >= c; c++)
              (u = i(e, f[c], r, a, l, h !== c)), (m[c] = u.end);
            for (d in t) g[d] = t[d];
            return (
              (g.values = m),
              ((a = new s(e, "bezier", 0, 0, u.pt, 2)).data = u),
              (a.plugin = l),
              (a.setRatio = n),
    ...
    _gsScope._gsDefine(
      ...
      function (e, t) {
        ...
        var d,
          ...
          q = function (e, t) {
            var i = W.createElementNS
              ? W.createElementNS(t || "http://www.w3.org/1999/xhtml", e)
              : W.createElement(e);
            return i.style ? i : W.createElement(e);
          },
          H = q("div"),
          B = q("img"),
          Y = (r._internals = { _specialProps: l }),
          ...
          G = (function () {
            ...
            return (
              ...
              (p =
                f &&
                parseFloat(U.substr(U.indexOf("Version/index.html") + 8, 2)) <
                  6),
          ...
          Z =
            "undefined" != typeof window
              ? window
              : W.defaultView || { getComputedStyle: function () {} },
          ee = function (e) {
            return Z.getComputedStyle(e);
          },
          te = (r.getStyle = function (e, t, i, n, s) {
            var o;
            return G || "opacity" !== t
              ? (!n && e.style[t]
                  ? (o = e.style[t])
                  ...
                  ? (o =
                      ...
                      i.getPropertyValue(t.replace(O, "-$1").toLowerCase()))
          ...
          ie = (Y.convertToPixels = function (e, i, n, s, o) {
            ...
            var a,
              ...
              h = 0 > n,
              p = 1 === n;
            if ((h && (n = -n), p && (n *= 100), "lineHeight" !== i || s))
              if ("%" === s && -1 !== i.indexOf("border"))
                ...
                if (
                  ...
                  f[d ? "borderLeftWidth" : "borderTopWidth"] = n + s;
                else {
                  if (
                    ((u = e.parentNode || W.body),
                    -1 !== te(u, "display").indexOf("flex") &&
                      (f.position = "absolute"),
                    (l = u._gsCache),
                    (c = t.ticker.frame),
                    l && d && l.time === c)
          ...
          ne = (Y.calculateOffset = function (e, t, i) {
            ...
            var n = "left" === t ? "Left" : "Top",
              s = te(e, "margin" + n, i);
            return (
              e["offset" + n] - (ie(e, t, parseFloat(s), s.replace(T, "")) || 0)
            );
          }),
          se = function (e, t) {
            var i,
              ...
              if ((i = t.length))
                for (; --i > -1; )
                  (-1 === (s = t[i]).indexOf("-transform") || Ae === s) &&
                    (o[s.replace(P, A)] = t.getPropertyValue(s));
              else
                for (i in t)
                  (-1 === i.indexOf("Transform") || je === i) && (o[i] = t[i]);
          ...
          le = function (e, t, i) {
            ...
            var n = parseFloat("width" === t ? e.offsetWidth : e.offsetHeight),
              ...
              o = s.length;
            for (i = i || ee(e); --o > -1; )
              (n -= parseFloat(te(e, "padding" + s[o], i, !0)) || 0),
                (n -= parseFloat(te(e, "border" + s[o] + "Width", i, !0)) || 0);
            return n;
          },
          ce = function (e, t) {
          ...
          me = (r.parseColor = function (e, t) {
            ...
            return (
              t &&
                ...
                (s = i[1] / 255),
                (o = i[2] / 255),
                (l = ((c = Math.max(n, s, o)) + (d = Math.min(n, s, o))) / 2),
                c === d
                  ? (r = a = 0)
                  : ((u = c - d),
                    (a = l > 0.5 ? u / (2 - c - d) : u / (c + d)),
                    (r =
                      c === n
                        ? (s - o) / u + (o > s ? 6 : 0)
                        : c === s
          ...
          ge = function (e, t) {
            ...
            for (i = 0; i < o.length; i++)
              (n = o[i]),
                (r += (s = e.substr(r, e.indexOf(n, r) - r)).length + n.length),
        ...
        var _e = function (e, t, i, n) {
            ...
            return d
              ? (s = t
                  ? function (e) {
                      ...
                      if (
                        ((t = (e.match(ve) || [o])[0]),
                        (h = (f = e.split(t).join("").match(y) || []).length),
                        d > h--)
                      )
                        for (; ++h < d; )
                          f[h] = i ? f[((h - 1) / 2) | 0] : r[h];
          ...
          ke =
            ((Y._parseToProxy = function (e, t, i, n, s, o) {
              var r,
                a,
                l,
                c,
                ...
                if (
                  ...
                  for (r = n.l; --r > 0; )
                    (l = "xn" + r),
                      ...
                      (f[a] = n[l]),
                      o || (c = new ye(n, l, a, c, n.rxp[l]));
                n = n._next;
              }
              return { proxy: f, end: h, firstMPT: c, pt: d };
            }),
            (Y.CSSPropTween = function (e, t, n, s, r, a, l, c, d, u, f) {
              (this.t = e),
                (this.p = t),
                (this.s = n),
                (this.c = s),
                (this.n = l || t),
                e instanceof ke || o.push(this.n),
          ...
          we = function (e, t, i, n, s, o) {
            var r = new ke(e, t, i, n - i, s, -1, o);
            return (r.b = i), (r.e = r.xs0 = n), r;
          },
          Te = (r.parseComplex = function (e, t, i, n, s, o, a, l, c, u) {
            (i = i || o || ""),
              "function" == typeof n && (n = n(v, g)),
              (a = new ke(e, t, 0, 0, a, u ? 2 : 1, null, !1, l, i, n)),
              (n += ""),
              s &&
                ve.test(n + i) &&
            ...
            for (
              (-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) &&
                (-1 !== (n + i).indexOf("rgb") || -1 !== (n + i).indexOf("hsl")
                  ? ((P = P.join(" ").replace(z, ", ").split(" ")),
                    (j = j.join(" ").replace(z, ", ").split(" ")))
                  : ((P = P.join(" ").split(",").join(", ").split(" ")),
                    (j = j.join(" ").split(",").join(", ").split(" "))),
                (A = P.length)),
                A !== j.length && (A = (P = (o || "").split(" ")).length),
                a.plugin = c,
                a.setRatio = u,
                ve.lastIndex = 0,
                f = 0;
              ...
              if (((m = P[f]), (y = j[f] + ""), (T = parseFloat(m)) || 0 === T))
                a.appendXtra(
                  "",
                  T,
                  de(y, T),
                  y.replace(b, ""),
                  !(!E || -1 === y.indexOf("px")) && Math.round,
                  !0
                );
              else if (s && ve.test(m))
                (D = ")" + ((D = y.indexOf(")") + 1) ? y.substr(D) : "")),
                  (O = -1 !== y.indexOf("hsl") && G),
                  (S = y),
                  (m = me(m, O)),
                  (y = me(y, O)),
                  (x = m.length + y.length > 6) && !G && 0 === y[3]
                    ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"),
                      (a.e = a.e.split(j[f]).join("transparent")))
                    : (G || (x = !1),
                      O
                        ? a
                            .appendXtra(
                        ...
                        : a
                            ...
                            .appendXtra("", m[1], y[1] - m[1], ",", Math.round)
                            .appendXtra(
                              "",
                              m[2],
                              y[2] - m[2],
                ...
                if (!(w = y.match(b)) || w.length !== k.length) return a;
                for (p = 0, h = 0; h < k.length; h++)
                  (C = k[h]),
                    (S = m.indexOf(C, p)),
                    a.appendXtra(
                      m.substr(p, S - p),
                      ...
                      de(w[h], C),
                      "",
                      !(!E || "px" !== m.substr(S + C.length, 2)) && Math.round,
                      0 === h
                    ),
                    (p = S + C.length);
                a["xs" + a.l] += m.substr(p);
            ...
            if (-1 !== n.indexOf("=") && a.data) {
              for (D = a.xs0 + a.data.s, f = 1; f < a.l; f++)
                D += a["xs" + f] + a.data["xn" + f];
              a.e = D + a["xs" + f];
            }
            return a.l || ((a.type = -1), (a.xs0 = a.e)), a.xfirst || a;
          }),
          xe = 9;
        for ((c = ke.prototype).l = c.pr = 0; --xe > 0; )
          (c["xn" + xe] = 0), (c["xs" + xe] = "");
        (c.xs0 = ""),
          (c._next =
            c._prev =
            ...
            c.rxp =
              null),
          (c.appendXtra = function (e, t, i, n, s, o) {
            var r = this,
              a = r.l;
            return (
              (r["xs" + a] += o && (a || r["xs" + a]) ? " " + e : e || ""),
              i || 0 === a || r.plugin
                ? (r.l++,
            ...
            if (!l[e]) {
              ...
              Ce(e, {
                parser: function (e, i, n, s, o, r, c) {
                  ...
                  return d
                    ? (d._cssRegister(), l[n].parse(e, i, n, s, o, r, c))
                    : (J("Error: " + t + " js file not loaded."), o);
                },
              });
            }
          });
        ((c = Se.prototype).parseComplex = function (e, t, i, n, s, o) {
          var r,
            a,
            l,
            c,
          ...
          if (
            ...
            for (
              ...
              (t = a[r] = a[r] || this.dflt),
                (i = l[r] = l[r] || this.dflt),
                f &&
                  (d = t.indexOf(f)) !== (u = i.indexOf(f)) &&
                  (-1 === u
                    ? (a[r] = a[r].split(f).join(""))
                    : -1 === d && (a[r] += " " + f));
            (t = a.join(", ")), (i = l.join(", "));
          }
          return Te(e, this.p, t, i, this.clrs, this.dflt, n, this.pr, s, o);
        }),
          (c.parse = function (e, t, i, n, o, r, a) {
            return this.parseComplex(
              e.style,
              this.format(te(e, this.p, s, !1, this.dflt)),
              this.format(t),
              o,
              r
            );
          ...
          (r.registerSpecialProp = function (e, t, i) {
            Ce(e, {
              parser: function (e, n, s, o, r, a, l) {
                var c = new ke(e, s, 0, 0, r, 2, s, !1, i);
        ...
        var Oe,
          ...
          $e = (function () {
            ...
            return (
              W.createElementNS &&
                ...
                (t.style[Ee] = "50% 50%"),
                (t.style[je] = "scaleX(0.5)"),
                (n = i === t.getBoundingClientRect().width && !(h && Me)),
                Fe.removeChild(e)),
              n
            );
          })(),
          Re = function (e, t, i, n, s, o) {
            var a,
              l,
              c,
              d,
            ...
            k && ((b = k.xOrigin), (y = k.yOrigin)),
              ...
              n &&
                ...
                (v = w[5]),
                (_ = f * m - h * p) &&
                  ((l = d * (m / _) + u * (-p / _) + (p * v - m * g) / _),
                  (c = d * (-h / _) + u * (f / _) - (f * v - h * g) / _),
                  (d = i.xOrigin = a[0] = l),
                  (u = i.yOrigin = a[1] = c))),
              k &&
                (o &&
                  ((i.xOffset = k.xOffset), (i.yOffset = k.yOffset), (k = i)),
                s || (!1 !== s && !1 !== r.defaultSmoothOrigin)
                  ? ((l = d - b),
                    (c = u - y),
                    (k.xOffset += l * w[0] + c * w[2] - l),
                    (k.yOffset += l * w[1] + c * w[3] - c))
          ...
          He = function (e, t) {
            ...
            if (
              (je
                ...
                : e.currentStyle &&
                  (n =
                    (n = e.currentStyle.filter.match(M)) && 4 === n.length
                      ? [
                          n[0].substr(4),
                          Number(n[2].substr(4)),
                          Number(n[1].substr(4)),
              ...
              je &&
                ...
                ((l = e.parentNode) && e.offsetParent) ||
                  ((r = 1), (a = e.nextSibling), Fe.appendChild(e)),
                (i =
                  !(n = te(e, Ae, null, !0)) ||
                  "none" === n ||
                  "matrix(1, 0, 0, 1, 0, 0)" === n),
                o ? (u.display = o) : Xe(u, "display"),
                r &&
                  (a
                    ? l.insertBefore(e, a)
                    : l
            ...
            for (s = (n || "").match(_) || [], xe = s.length; --xe > -1; )
              (o = Number(s[xe])),
                (s[xe] = (r = o - (o |= 0))
                  ? ((r * d + (0 > r ? -0.5 : 0.5)) | 0) / d + o
                  : o);
            return t && s.length > 6
              ? [s[0], s[1], s[4], s[5], s[12], s[13]]
              : s;
          },
          Be = (Y.getTransform = function (e, i, n, s) {
            ...
            var o,
              ...
              d,
              u,
              f = (n && e._gsTransform) || new Ie(),
              h = f.scaleX < 0,
              p = 2e-5,
              m = 1e5,
              g =
                (Me &&
                  (parseFloat(te(e, Ee, i, !1, "0 0 0").split(" ")[2]) ||
                    f.zOrigin)) ||
                0,
            ...
            if (
              ...
              if (16 === o.length) {
                var _,
                  ...
                  R = Math.atan2(P, M);
                f.zOrigin &&
                  ((I = A * (L = -f.zOrigin) - o[12]),
                  (z = E * L - o[13]),
                  (L = M * L + f.zOrigin - o[14])),
                  (f.rotationX = R * $),
                  R &&
                    ((_ = D * (k = Math.cos(-R)) + A * (w = Math.sin(-R))),
                    (b = O * k + E * w),
                    (y = P * k + M * w),
                    (A = D * -w + A * k),
                    (E = O * -w + E * k),
                  ...
                  (f.rotationY = R * $),
                  R &&
                    ((b = x * (k = Math.cos(-R)) - E * (w = Math.sin(-R))),
                    (y = S * k - M * w),
                    (E = x * w + E * k),
                    (M = S * w + M * k),
                    (F = C * w + F * k),
                  ...
                  (f.rotation = R * $),
                  R &&
                    ((_ = T * (k = Math.cos(R)) + x * (w = Math.sin(R))),
                    (b = D * k + O * w),
                    (y = A * k + E * w),
                    (x = x * k - T * w),
                    (O = O * k - D * w),
                  ...
                  (R = Math.atan2(D, O)),
                  (f.scaleX =
                    ((Math.sqrt(T * T + x * x + S * S) * m + 0.5) | 0) / m),
                  (f.scaleY = ((Math.sqrt(O * O + P * P) * m + 0.5) | 0) / m),
                  (f.scaleZ =
                    ((Math.sqrt(A * A + E * E + M * M) * m + 0.5) | 0) / m),
                  (T /= f.scaleX),
                  (D /= f.scaleY),
                  (x /= f.scaleX),
                  (O /= f.scaleY),
                  Math.abs(R) > p
                    ? ((f.skewX = R * $),
                      (D = 0),
                      "simple" !== f.skewType && (f.scaleY *= 1 / Math.cos(R)))
                    : (f.skewX = 0),
                  ...
                  (f.z = L),
                  f.svg &&
                    ((f.x -= f.xOrigin - (f.xOrigin * T - f.yOrigin * D)),
                ...
                (f.x = o[4] || 0),
                  ...
                  (l = Math.sqrt(W * W + q * q)),
                  (c = Math.sqrt(B * B + H * H)),
                  (d = W || q ? Math.atan2(q, W) * $ : f.rotation || 0),
                  (u = H || B ? Math.atan2(H, B) * $ + d : f.skewX || 0),
                  (f.scaleX = l),
                  (f.scaleY = c),
                  (f.rotation = d),
                  (f.skewX = u),
                  Me &&
                    ...
                    (f.scaleZ = 1)),
                  f.svg &&
                    ((f.x -= f.xOrigin - (f.xOrigin * W + f.yOrigin * H)),
                    (f.y -= f.yOrigin - (f.xOrigin * q + f.yOrigin * B)));
              }
          ...
          Ye = function (e) {
            var t,
              ...
              c = ((Math.sin(o) * -n.scaleY * r) | 0) / r,
              d = ((Math.cos(o) * n.scaleY * r) | 0) / r,
              u = this.t.style,
              f = this.t.currentStyle;
            if (f) {
              (i = l), (l = -c), (c = -i), (t = f.filter), (u.filter = "");
              var h,
                p,
              ...
              if (
                (null != n.ox &&
                  ((y +=
                    (h = (n.oxp ? g * n.ox * 0.01 : n.ox) - g / 2) -
                    (h * a +
                      (p = (n.oyp ? v * n.oy * 0.01 : n.oy) - v / 2) * l)),
                  (k += p - (h * c + p * d))),
                _
                  ? (b +=
                      ", Dx=" +
                ...
                for (
                  ...
                  (C =
                    (i =
                      -1 !== (w = f[(S = ae[xe])]).indexOf("px")
                        ? parseFloat(w)
                        : ie(this.t, S, parseFloat(w), w.replace(T, "")) ||
                          0) !== n[S]
                      ? 2 > xe
                        ? -n.ieOffsetX
                        : -n.ieOffsetY
                ...
                if (
                  ...
                  D || W || L
                    ? ((D *= F),
                      ...
                      L &&
                        ...
                        (I +=
                          S.yOrigin -
                          (S.xOrigin * o + S.yOrigin * r) +
                          S.yOffset),
                        Oe &&
                          (S.xPercent || S.yPercent) &&
                          ((g = this.t.getBBox()),
                          (M += 0.01 * S.xPercent * g.width),
                          (I += 0.01 * S.yPercent * g.height)),
                        (g = 1e-6) > M && M > -g && (M = 0),
                        g > I && I > -g && (I = 0)),
                      (y =
                        ((i * x) | 0) / x +
                  ...
                  (d = 1),
                    ...
                    (D = P * F) &&
                      ...
                      (o *= v)),
                    (D = O * F) &&
                      ((t = n * (v = Math.cos(D)) + s * (_ = Math.sin(D))),
                      (b = r * v + a * _),
                      (c = d * _),
                      (f = p * _),
                      (s = n * -_ + s * v),
        ...
        ((c = Ie.prototype).x =
              ...
              parser: function (e, t, i, n, o, a, l) {
                ...
                if (
                  ...
                  ((u = H.style)[je] = P),
                    ...
                    O.svg &&
                      ...
                      (S.transformOrigin || S.svgOrigin) &&
                        ...
                        (m = P.xOrigin),
                        (_ = P.yOrigin),
                        (d.x -= P.xOffset - O.xOffset),
                        (d.y -= P.yOffset - O.yOffset)),
                      (m || _) &&
                        ((b = He(H, !0)),
                        (d.x -= m - (m * b[0] + _ * b[2])),
                        (d.y -= _ - (m * b[1] + _ * b[3])))),
                    W.body.removeChild(H),
                    d.perspective || (d.perspective = O.perspective),
                    null != S.xPercent &&
                      (d.xPercent = ue(S.xPercent, O.xPercent)),
                    null != S.yPercent &&
                      (d.yPercent = ue(S.yPercent, O.yPercent));
                  ...
                  if (
                    ...
                    if ("object" == typeof p) for (u in p) S[u] = p[u];
                    else S.rotation = p;
                  "string" == typeof S.x &&
                    -1 !== S.x.indexOf("%") &&
                    ((d.x = 0), (d.xPercent = ue(S.x, O.xPercent))),
                    "string" == typeof S.y &&
                      -1 !== S.y.indexOf("%") &&
                      ((d.y = 0), (d.yPercent = ue(S.y, O.yPercent))),
                    (d.rotation = fe(
                      "rotation" in S
                        ? S.rotation
                        : "shortRotation" in S
                    ...
                    (d.skewX = fe(S.skewX, O.skewX)),
                    (d.skewY = fe(S.skewY, O.skewY));
                }
                for (
                  Me &&
                    null != S.force3D &&
                    ((O.force3D = S.force3D), (h = !0)),
                    (f =
                      O.force3D ||
                      O.z ||
                      O.rotationX ||
                ...
                return (
                  (P =
                    "function" == typeof S.transformOrigin
                      ? S.transformOrigin(v, g)
                      : S.transformOrigin),
                  O.svg &&
                    (P || S.svgOrigin) &&
                    ((m = O.xOffset),
                    (_ = O.yOffset),
                    Re(e, ce(P), d, S.svgOrigin, S.smoothOrigin),
                    (o = we(
                      O,
                      "xOrigin",
                      (k ? O : d).xOrigin,
                      ...
                      ? ((h = !0),
                        ...
                        Me
                          ? ((u = O.zOrigin),
                            ...
                            (o.xs0 = o.e =
                              P[0] + " " + (P[1] || "50%") + " 0px"),
                            ((o = new ke(O, "zOrigin", 0, 0, o, -1, o.n)).b =
                              u),
                            (o.xs0 = o.e = O.zOrigin))
                          : (o.xs0 = o.e = P))
                      : ce(P + "", O)),
                  h &&
                    (n._transformType =
                      (O.svg && Oe) || (!f && 3 !== this._transformType)
                        ? 2
                        : 3),
                  c && (l.scale = c),
                  o
          ...
          Ce("borderRadius", {
            ...
            parser: function (e, t, i, o, r, a) {
              ...
              for (
                ...
                this.p.indexOf("border") && (x[c] = Q(x[c])),
                  -1 !== (f = u = te(e, x[c], s, !1, "0px")).indexOf(" ") &&
                  ...
                  (y = "=" === h.charAt(1))
                    ? ((m = parseInt(h.charAt(0) + "1", 10)),
                      (h = h.substr(2)),
                      (m *= parseFloat(h)),
                      (_ = h.substr((m + "").length - (0 > m ? 1 : 0)) || ""))
                    : ((m = parseFloat(h)), (_ = h.substr((m + "").length))),
                  "" === _ && (_ = n[i] || b),
                  _ !== b &&
                    ((k = ie(e, "borderLeft", p, b)),
                    (w = ie(e, "borderTop", p, b)),
                    "%" === _
                      ? ((f = (k / g) * 100 + "%"), (u = (w / v) * 100 + "%"))
                      : "em" === _
                      ? ((f = k / (T = ie(e, "borderLeft", 1, "em")) + "em"),
                        (u = w / T + "em"))
                      : ((f = k + "px"), (u = w + "px")),
                    y &&
                      ((h = parseFloat(f) + m + _),
                      (d = parseFloat(u) + m + _))),
                  (r = Te(S, x[c], f + " " + u, h + " " + d, !1, "0px", r));
              return r;
            },
            prefix: !0,
            ...
            "borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius",
            {
              ...
              parser: function (e, t, i, n, o, r) {
                return Te(
                  e.style,
                  i,
                  this.format(te(e, i, s, !1, "0px 0px")),
                  this.format(t),
                  !1,
                  "0px",
                  o
          ...
          Ce("backgroundPosition", {
            ...
            parser: function (e, t, i, n, o, r) {
              ...
              if (
                ...
                v.split(",").length < 2 &&
                (f = te(e, "backgroundImage").replace(j, "")) &&
                "none" !== f
              ) {
                for (
                  a = g.split(" "),
                  ...
                  (d = -1 !== (g = a[c]).indexOf("%")) !==
                    ...
                    ((u =
                      0 === c
                        ? e.offsetWidth - B.width
                        : e.offsetHeight - B.height),
                    (a[c] = d
            ...
            parser: function (e, t, i, n, o, r) {
              ...
              return (
                9 > m
                  ...
                  : ((a = this.format(te(e, this.p, s, !1, this.dflt))),
                    (t = this.format(t))),
                this.parseComplex(e.style, a, t, o, r)
              );
            },
          }),
          Ce("textShadow", {
          ...
          Ce("border", {
            ...
            parser: function (e, t, i, n, o, r) {
              ...
              return (
                "px" !== c &&
                  (a = parseFloat(a) / ie(e, "borderTopWidth", 1, c) + c),
                this.parseComplex(
                  e.style,
                  this.format(
                    a +
                      " " +
                      te(e, "borderTopStyle", s, !1, "solid") +
                      " " +
                      te(e, "borderTopColor", s, !1, "#000")
                  ),
                  l.join(" "),
                  o,
                  r
          ...
          Ce("float,cssFloat,styleFloat", {
            parser: function (e, t, i, n, s, o) {
              ...
              return new ke(r, a, 0, 0, s, -1, i, !1, 0, r[a], t);
            },
          });
        var Ge = function (e) {
          var t,
          ...
          100 === s &&
            ...
            -1 === n.indexOf("radient(") &&
            -1 === n.indexOf("oader(")
              ? (i.removeAttribute("filter"), (t = !te(this.data, "filter")))
              : ((i.filter = n.replace(C, "")), (t = !0))),
            t ||
        ...
        Ce("opacity,alpha,autoAlpha", {
          ...
          parser: function (e, t, i, n, o, r) {
            ...
            return (
              ...
              c &&
                1 === a &&
                "hidden" === te(e, "visibility", s) &&
                0 !== t &&
                (a = 0),
              G
                ? (o = new ke(l, "opacity", a, t - a, o))
                : (((o = new ke(l, "opacity", 100 * a, 100 * (t - a), o)).xn1 =
                    c ? 1 : 0),
                  (l.zoom = 1),
                  (o.type = 2),
          ...
          Je = function (e) {
            if (((this.t._gsClassPT = this), 1 === e || 0 === e)) {
              ...
              for (var t = this.data, i = this.t.style; t; )
                t.v ? (i[t.p] = t.v) : Xe(i, t.p), (t = t._next);
              1 === e &&
        ...
        Ce("className", {
          parser: function (e, t, n, o, r, a, l) {
            var c,
              ...
              m = e.style.cssText;
            if (
              (((r = o._classNamePT = new ke(e, n, 0, 0, r, 2)).setRatio = Je),
              (r.pr = -11),
              (i = !0),
              (r.b = p),
              (d = se(e, s)),
        ...
        for (
          Ce("clearProps", {
            parser: function (e, t, n, s, o) {
              return (
                ((o = new ke(e, n, 0, 0, o, 2)).setRatio = Ve),
                (o.e = t),
                (o.pr = -10),
                (o.data = s._tween),
                (i = !0),
          ...
          (c._onInitTween = function (e, t, a, c) {
            ...
            if (
              ...
              "string" == typeof t &&
                ...
                (C.cssText = b + ";" + t),
                (h = oe(e, h, se(e)).difs),
                !G && S.test(t) && (h.opacity = parseFloat(RegExp.$1)),
                (t = h),
                (C.cssText = b)),
              t.className
                ? (this._firstPT = m =
              ...
              for (
                ...
                _ = _._next;
              (T = new ke(e, "transform", 0, 0, null, 2)),
                this._linkCSSP(T, null, _),
                (T.setRatio = je ? Ue : Ye),
                (T.data = this._transform || Be(e, s, !0)),
                (T.tween = a),
                (T.pr = -1),
                o.pop();
            }
            if (i) {
              for (; m; ) {
                for (k = m._next, _ = b; _ && _.pr > m.pr; ) _ = _._next;
                (m._prev = _ ? _._prev : y) ? (m._prev._next = m) : (b = m),
          ...
          (c.parse = function (e, t, i, o) {
            ...
            for (r in t) {
              if (
                ((h = t[r]),
                (a = l[r]),
                "function" != typeof h || (a && a.allowFunc) || (h = h(v, g)),
                a)
              )
                i = a.parse(e, h, r, this, i, o, t);
              else {
                if ("--" === r.substr(0, 2)) {
                ...
                (f = te(e, r, s) + ""),
                  ...
                  (_ && D.test(h))
                    ? (_ ||
                        (h =
                          ((h = me(h)).length > 3 ? "rgba(" : "rgb(") +
                          h.join(",") +
                          ")"),
                      (i = Te(y, r, f, h, !0, "transparent", i, 0, o)))
                    : _ && L.test(h)
                    ? (i = Te(y, r, f, h, !0, null, i, 0, o))
                    : ((p =
                        (c = parseFloat(f)) || 0 === c
                          ? f.substr((c + "").length)
                          : ""),
        ...
        (c._addLazySet = function (e, t, i) {
          var n = (this._firstPT = new ke(e, t, 0, 0, this._firstPT, 2));
        ...
        var Qe = function (e, t, i) {
          ...
          if (e.slice) for (s = e.length; --s > -1; ) Qe(e[s], t, i);
            ...
            for (s = (n = e.childNodes).length; --s > -1; )
              (r = (o = n[s]).type),
                o.style && (t.push(se(o)), i && i.push(o)),
                (1 !== r && 9 !== r && 11 !== r) ||
                  !o.childNodes.length ||
                  Qe(o, t, i);
        };
        return (
          (r.cascadeTo = function (e, i, n) {
            ...
            for (
              ...
              if ((o = oe(f[s], d[s], u[s])).firstMPT) {
                for (r in ((o = o.difs), n)) h[r] && (o[r] = n[r]);
                for (r in ((a = {}), o)) a[r] = d[s][r];
                c.push(t.fromTo(f[s], i, a, o));
              }
            return c;
          }),
          e.activate([r]),
            ...
            (n = e._next),
              e.pg
                ...
                : e.n === o &&
                  (2 === e.f && e.t
                    ? i(e.t._firstPT, l[o])
                    : (this._add(e.t, o, e.s, e.c, l[o]),
                      n && (n._prev = e._prev),
                      e._prev
                        ? (e._prev._next = n)
                        : r._firstPT === e && (r._firstPT = n),
    ...
    _gsScope._gsDefine(
      ...
      function (e) {
        ...
        return (
          ...
          ((v = t.prototype = new e()).constructor = t),
          (v.getRatio = function (e) {
            return (
          ...
          ((v = i.prototype = new e()).constructor = i),
          (v.getRatio = function (e) {
            return (
          ...
          (n = c(
            ...
            function (t) {
              ...
              for (
                ...
                (r = c[f]), (a = new h(r.x, r.y, a));
              this._prev = new h(0, 0, 0 !== a.t ? a : a.next);
            },
            !0
          )),
          ((v = n.prototype = new e()).constructor = n),
          (v.getRatio = function (e) {
            var t = this._prev;
            if (e > t.t) {
  ...
  (function (e, t) {
    ...
    var r,
      ...
      _ = function (n, o, r, a) {
        ...
        (this.check = function (c) {
          for (var d, f, h, p, m = o.length, g = m; --m > -1; )
            (d = v[o[m]] || new _(o[m], [])).gsClass
              ? ((l[m] = d.gsClass), g--)
              : c && d.sc.push(this);
          if (0 === g && r) {
            if (
              ((h = (f = ("com.greensock." + n).split(".")).pop()),
              (p = u(f.join("."))[h] = this.gsClass = r.apply(r, l)),
              a)
            )
              if (
                ((s[h] = i[h] = p),
    ...
    var k = [0, 0, 1, 1],
      ...
      x = (w.register = function (e, t, i, n) {
        for (
          ...
          for (
            o = l[c],
              s = n ? y("easing." + o, null, !0) : f.easing[o] || {},
              r = d.length;
            --r > -1;
    ...
    for (
      (l = w.prototype)._calcEnd = !1,
        ...
        a = (r = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"]).length;
      --a > -1;
    ...
    ((l = S.prototype).addEventListener = function (e, t, i, n, s) {
      s = s || 0;
      var o,
        r,
        a = this._listeners[e],
    ...
    var C = e.requestAnimationFrame,
      ...
      P = O();
    for (a = (r = ["ms", "moz", "webkit", "o"]).length; --a > -1 && !C; )
      (C = e[r[a] + "RequestAnimationFrame"]),
        (D =
    ...
    y("Ticker", function (e, t) {
      ...
      S.call(l),
        ...
        (l.lagSmoothing = function (e, t) {
          return arguments.length
            ? ((p = e || 1 / h), void (g = Math.min(t, p, 0)))
            : 1 / h > p;
        }),
        (l.sleep = function () {
          null != o &&
            (f && D ? D(o) : clearTimeout(o),
            (s = m),
            (o = null),
            l === c && (d = !1));
        }),
        ...
        (l.fps = function (e) {
          return arguments.length
            ? ((r = 1 / ((i = e) || 60)), (a = this.time + r), void l.wake())
            : i;
        }),
        (l.useRAF = function (e) {
      ...
      ((l = f.Ticker.prototype = new f.events.EventDispatcher()).constructor =
        f.Ticker);
    var j = y("core.Animation", function (e, t) {
      if (
        ((this.vars = t = t || {}),
    ...
    (c = j.ticker = new f.Ticker()),
      ((l = j.prototype)._dirty = l._gc = l._initted = l._paused = !1),
    ...
    var A = function () {
      d &&
        O() - P > 2e3 &&
        ("hidden" !== (n || {}).visibilityState || !c.lagSmoothing()) &&
        c.wake();
      ...
      (l.isActive = function () {
        ...
        return (
          ...
          (!this._gc &&
            ...
            t.isActive() &&
            (e = t.rawTime(!0)) >= i &&
            e < i + this.totalDuration() / this._timeScale - h)
        );
      }),
        ...
        if (this._timeline) {
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime !== e || 0 === this._duration) &&
              (z.length && Q(), this.render(e, t, !1), z.length && Q());
        }
        return this;
      }),
    ...
    var E = y("core.SimpleTimeline", function (e) {
      j.call(this, 0, e),
        (this.autoRemoveChildren = this.smoothChildTiming = !0);
    });
    ((l = E.prototype = new j()).constructor = E),
      (l.kill()._gc = !1),
      ...
      (l.add = l.insert =
        function (e, t, i, n) {
          ...
          if (
            ...
            for (o = e._startTime; s && s._startTime > o; ) s = s._prev;
          return (
            s
    ...
    var M = y(
        ...
        function (t, i, n) {
          if (
            (j.call(this, i, n), (this.render = M.prototype.render), null == t)
          )
          ...
          if (
            ((this._overwrite = l =
              null == l
                ...
                ? l >> 0
                : X[l]),
            (a || t instanceof Array || (t.push && g(t))) &&
              "number" != typeof t[0])
          )
            for (
              this._targets = r = p(t),
              ...
              (o = r[s])
                ? "string" != typeof o
                  ? o.length &&
                    o !== e &&
                    o[0] &&
                    (o[0] === e || (o[0].nodeType && o[0].style && !o.nodeType))
                    ? (r.splice(s--, 1), (this._targets = r = r.concat(p(o))))
                    : ((this._siblings[s] = Z(o, this, !1)),
                      1 === l &&
                        this._siblings[s].length > 1 &&
                        te(o, this, null, 1, this._siblings[s]))
                  : "string" == typeof (o = r[s--] = M.selector(o)) &&
                    r.splice(s + 1, 1)
                : r.splice(s--, 1);
          else
            (this._propLookup = {}),
          ...
          (this.vars.immediateRender ||
            ...
            ((this._time = -h), this.render(Math.min(0, -this._delay)));
        },
        !0
      ),
      I = function (t) {
    ...
    ((l = M.prototype = new j()).constructor = M),
      (l.kill()._gc = !1),
      (l.ratio = 0),
    ...
    var z = [],
      ...
      W = function (e, t, i, n) {
        ...
        for (
          ...
          (d = o[a]),
            (h += (c = t.substr(f, t.indexOf(d, f) - f)) || !a ? c : ","),
            (f += c.length),
                ...
                (u._firstPT = {
                  ...
                  c:
                    ("=" === d.charAt(1)
                      ...
                      : parseFloat(d) - r) || 0,
                  f: 0,
                  m: p && 4 > p ? Math.round : N,
                })),
            (f += d.length);
        return (
          (h += t.substr(f)) && u.push(h),
          (u.setRatio = R),
          $.test(t) && (u.end = null),
          u
        );
      },
      q = function (e, t, i, n, s, o, r, a, l) {
      ...
      J = (j._rootFramesTimeline = new E()),
      V = (j._rootTimeline = new E()),
      K = 30,
    ...
    (V._startTime = c.time),
      ...
      (V._active = J._active = !0),
      setTimeout(Q, 1),
      (j._updateRoot = M.render =
        function () {
          var e, t, i;
          if (
            (z.length && Q(),
            V.render((c.time - V._startTime) * V._timeScale, !1, !1),
            J.render((c.frame - J._startTime) * J._timeScale, !1, !1),
            z.length && Q(),
            c.frame >= K)
          ) {
            for (i in ((K = c.frame + (parseInt(M.autoSleep, 10) || 120)), Y)) {
              for (e = (t = Y[i].tweens).length; --e > -1; )
    ...
    var Z = function (e, t, i) {
        var n,
          ...
          o = e._gsTweenID;
        if (
          (Y[o || (e._gsTweenID = o = "t" + U++)] ||
            (Y[o] = { target: e, tweens: [] }),
          t && (((n = Y[o].tweens)[(s = n.length)] = t), i))
        )
      ...
      te = function (e, t, i, n, s) {
        ...
        if (1 === n || n >= 4) {
          for (l = s.length, o = 0; l > o; o++)
            if ((a = s[o]) !== t) a._gc || (a._kill(null, e, t) && (r = !0));
            else if (5 === n) break;
          return r;
        }
        var c,
        ...
        for (o = s.length; --o > -1; )
          (a = s[o]) === t ||
            ...
            (a._timeline !== t._timeline
              ? ((c = c || ie(t, 0, p)), 0 === ie(a, c, p) && (u[f++] = a))
              : a._startTime <= d &&
                a._startTime + a.totalDuration() / a._timeScale > d &&
                (((p || !a._initted) && d - a._startTime <= 2 * h) ||
                  (u[f++] = a)));
        for (o = f; --o > -1; )
          if (
            ((l = (a = u[o])._firstPT),
      ...
      ie = function (e, t, i) {
        for (
          var n = e._timeline, s = n._timeScale, o = e._startTime;
          n._timeline;
        ...
        return (o /= s) > t
          ? o - t
          : (i && o === t) || (!e._initted && 2 * h > o - t)
          ? h
          : (o += e.totalDuration() / e._timeScale / s) > t + h
          ? 0
          : o - t - h;
      };
    (l._init = function () {
      var e,
        ...
        u = this._startAt;
      if (r.startAt) {
        for (n in (u && (u.render(-1, !0), u.kill()), (s = {}), r.startAt))
          s[n] = r.startAt[n];
        if (
          ((s.data = "isStart"),
          (s.overwrite = !1),
      ...
      if (
        ...
        for (o = this._targets.length, e = 0; o > e; e++)
          this._initProps(
            this._targets[e],
            (this._propLookup[e] = {}),
            this._siblings[e],
      ...
      (l._initProps = function (t, i, n, s, o) {
        var r, a, l, c, d, u;
        if (null == t) return !1;
        for (r in (L[t._gsTweenID] && Q(),
        this.vars.css ||
          (t.style &&
            t !== e &&
            t.nodeType &&
        ...
        this.vars))
          if (((u = this.vars[r]), G[r]))
            ...
            B[r] &&
            (c = new B[r]())._onInitTween(t, this.vars[r], this, o)
          ) {
            for (
              this._firstPT = d =
                {
        ...
        return s && this._kill(s, t)
          ? this._initProps(t, i, n, s, o)
          : this._overwrite > 1 &&
            this._firstPT &&
            n.length > 1 &&
            te(t, this, i, this._overwrite, n)
          ? (this._kill(i, t), this._initProps(t, i, n, s, o))
          : (this._firstPT &&
        ...
        if (e >= c - h && e >= 0)
          (a._totalTime = a._time = c),
            ...
            0 === c &&
              ...
              (0 > d ||
                ...
                (d === h && "isPause" !== a.data)) &&
                d !== e &&
                ((i = !0), d > h && (s = "onReverseComplete")),
              (a._rawPrevTime = r = !t || e || d === e ? e : h));
        else if (h > e)
          ...
          (1 === f || (3 === f && u >= 0.5)) && (u = 1 - u),
            ...
            1 === p
              ...
              : 4 === p && (u *= u * u * u * u),
            (a.ratio =
              1 === f ? 1 - u : 2 === f ? u : 0.5 > e / c ? u / 2 : 1 - u / 2);
      ...
      (l.invalidate = function () {
        ...
        return (
          ...
          this.vars.immediateRender &&
            ((this._time = -h), this.render(e, !1, !1 !== this.vars.lazy)),
          this
        );
      }),
      (l._enabled = function (e, t) {
        ...
        return (
          j.prototype._enabled.call(this, e, t),
      ...
      (M.killTweensOf = M.killDelayedCallsTo =
        function (e, t, i) {
          ...
          for (var n = M.getTweensOf(e, t), s = n.length; --s > -1; )
            n[s]._kill(i, e);
        });
    var ne = y(
      "plugins.TweenPlugin",
    ...
    if (
      ...
      (ne.activate = function (e) {
        for (var t = e.length; --t > -1; )
          e[t].API === ne.API && (B[new e[t]()._propName] = e[t]);
        return !0;
      }),
      (b.plugin = function (e) {
        ...
        for (t in ((a.constructor = r), (r.API = e.API), o))
    ...
    window.SplitType = (function (e, t, i) {
      ...
      function l(e, t, s) {
        var o,
          r = {};
        return (
          n(e) && ((o = e[p] || (e[p] = ++g)), (r = m[o] || (m[o] = {}))),
          s === i ? (t === i ? r : r[t]) : t !== i ? ((r[t] = s), s) : void 0
        );
      }
      function c(e) {
        var t = e && e[p];
      ...
      function u(e) {
        ...
        if (
          ((function (e) {
            ...
            ((i = e.trim()),
            (e =
              "#" === i[0] && !/[^\w]/.test((n = i.slice(1)))
                ? t.getElementById(n)
                : t.querySelectorAll(i))),
          i || o(e))
        )
          return o(e) ? [e] : _.call(e);
        if (s(e))
          for (l = 0, r = e.length; l < r; l++)
            if (s(e[l]))
              for (c = 0, a = e[l].length; c < a; c++)
                o(e[l][c]) && d.push(e[l][c]);
            else o(e[l]) && d.push(e[l]);
        return d;
      }
      function f(t) {
        var i,
        ...
        if (
          ((s = h ? d("div") : w()),
          (b.innerHTML = t.innerHTML.replace(/<br\s*\/?>/g, " " + u + " ")),
          (o = b.textContent
            .replace(/\s+/g, " ")
            .trim()
            .split(" ")
            .map(function (e) {
              if (e === u) return s.appendChild(d("br")), null;
              if (m) {
          ...
          (t.innerHTML = ""),
          t.appendChild(s),
          v.apply(this.words, o),
          v.apply(this.chars, k),
          g || h)
        ) {
          var x,
            S,
            ...
            I,
            z = [];
          (j = l(t).nodes = t.getElementsByTagName(c)),
            (A = t.parentElement),
                ...
                return (
                  s.appendChild(
                    (i = d(c, {
                      ...
                      style:
                        "display: block; text-align:" + I + "; width: 100%;",
                    }))
                  ),
                  g &&
                    ((l(i).type = "line"),
                  ...
                  r(e, function (e) {
                    p
                      ? i.appendChild(e)
                      : m
                      ? _.call(e.children).forEach(function (e) {
                          i.appendChild(e);
                        })
                      : i.appendChild(T(e.textContent)),
                      i.appendChild(T(" "));
                  }),
                  i
                );
            ...
            g &&
              ...
              r(j, function (e) {
                ...
                (e.style.top = i ? 0 : l(e).top + "px"),
                  (e.style.left = t
                    ? D.left + "px"
                    : (i ? l(e).left - D.left : l(e).left) + "px"),
                  (e.style.height = l(e).height + "px"),
                  (e.style.width = t ? D.width + "px" : l(e).width + "px"),
      ...
      if (t.addEventListener && Function.prototype.bind) {
        var p = "splitType" + 1 * new Date(),
          ...
          b = Object.keys,
          y = (Object.prototype.hasOwnProperty, Object.defineProperty),
          k = (Object.defineProperties, Object.getOwnPropertyDescriptor),
          w = t.createDocumentFragment.bind(t),
          T = t.createTextNode.bind(t),
          x = {
            splitClass: "",
            lineClass: "line",
            wordClass: "word",
        ...
        return (
          ...
          (h.prototype.split = function (e) {
            this.revert(),
              ...
              (this.words = []),
              (this.chars = []),
              e !== i && (this.settings = a(this.settings, e)),
              r(
                this.elements,
                function (e) {
                  f.call(this, e), (l(e).isSplit = !0);
                },
                this
              ),
              (this.isSplit = !0),
    ...
    (e = function (e, t) {
      ...
      ((DateFormatter = function (e) {
        ...
        parseDate: function (t, i) {
          ...
          for (
            s = t.replace(h.separators, "\0").split("\0"), o = 0;
            o < s.length;
            o++
          )
            switch (((r = s[o]), (a = parseInt(r)), n[o])) {
              case "y":
              case "Y":
                if (!a) return null;
                (u = r.length),
              ...
              case "h":
                if (
                  ...
                  (d = e(f, g.meridiem[0]) ? 0 : e(f, g.meridiem[1]) ? 12 : -1),
                    1 <= a && a <= 12 && -1 < d
                      ? (v.hour = a + d - 1)
                      : 0 <= a && a <= 23 && (v.hour = a);
                else {
        ...
        guessDate: function (e, t) {
          ...
          for (s = 0; s < l.length; s++) {
            if (((u = 2), (r = l[s]), (a = parseInt(r.substr(0, 2))), isNaN(a)))
              return null;
            switch (s) {
              case 0:
            ...
            0 < (o = r.substr(u)).length && l.splice(s + 1, 0, o);
          }
          return d;
        },
          ...
          ? (e(this).hasClass("xdsoft_scroller_box") ||
              ...
              (v = function (e) {
                ...
                t < 0 && (t = 0),
                  ...
                  l.trigger("scroll_element.xdsoft_scroller", [d ? t / d : 0]);
              }),
              a
                .on(
                  ...
                  (s = l[0].clientHeight),
                    ...
                    1 < c
                      ...
                      : (a.show(),
                        ...
                        (d = r[0].offsetHeight - a[0].offsetHeight),
                        !0 !== i &&
              ...
              l.on("mousewheel", function (e) {
                ...
                return (
                  (t -= 20 * e.deltaY) < 0 && (t = 0),
                  l.trigger("scroll_element.xdsoft_scroller", [t / (o - s)]),
                  e.stopPropagation(),
                  !1
                );
              }),
              l.on("touchstart", function (e) {
                (u = c(e)), (h = Math.abs(parseInt(n.css("marginTop"), 10)));
              }),
      ...
      return (
        (r = function (t) {
          var o,
            ...
            N = 0;
          S.id && O.attr("id", S.id),
            S.style && O.attr("style", S.style),
            S.weeks && O.addClass("xdsoft_showweeks"),
            S.rtl && O.addClass("xdsoft_rtl"),
            O.addClass("xdsoft_" + S.theme),
            O.addClass(S.className),
            A.find(".xdsoft_month span").after(F),
            A.find(".xdsoft_year span").after($),
            A.find(".xdsoft_month,.xdsoft_year").on(
              ...
              function (t) {
                ...
                return (
                  s.xdsoftScroller(
                    S,
                    r / (s.children()[0].offsetHeight - s[0].clientHeight)
                  ),
                  t.stopPropagation(),
                  !1
                );
          ...
          var W = function (e) {
            ...
            Math.sqrt(n * n + s * s) > S.touchMovedThreshold &&
              (this.touchMoved = !0);
          };
          function q() {
            var e,
            ...
            return (
              S.startDate
                ...
                : S.defaultDate &&
                  ((i = C.strToDateTime(S.defaultDate)),
                  S.defaultTime &&
                    ((e = C.strtotime(S.defaultTime)),
                ...
                t.on("keydown.xdsoft", function (i) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      d += 8 === l ? 0 : 1;
                    s(n.mask, a)
                      ? ((this.value = a), o(this, d))
                      : "" === e.trim(a)
                      ? (this.value = n.mask.replace(/[0-9]/g, "_"))
                      : t.trigger("error_input.xdsoft");
                  } else if ((-1 !== [b, y, k, w, T].indexOf(l) && x) || -1 !== [f, p, g, h, m, _, c, v, u].indexOf(l)) return !0;
          ...
          A.find(".xdsoft_select")
              ...
              if (!this.touchMoved) {
                ...
                C &&
                  ...
                  S.onChangeMonth &&
                    ...
                    S.onChangeMonth.call(O, C.currentTime, O.data("input")),
                  t !== C.currentTime.getFullYear() &&
                    e.isFunction(S.onChangeYear) &&
                    S.onChangeYear.call(O, C.currentTime, O.data("input"));
              }
            }),
            (O.getValue = function () {
            ...
            (O.setOptions = function (n) {
              ...
              (S = e.extend(!0, {}, S, n)),
                n.allowTimes &&
                  ...
                  n.allowTimes.length &&
                  (S.allowTimes = e.extend(!0, [], n.allowTimes)),
                n.weekends &&
                  e.isArray(n.weekends) &&
                  n.weekends.length &&
                  (S.weekends = e.extend(!0, [], n.weekends)),
                n.allowDates &&
                  e.isArray(n.allowDates) &&
                  n.allowDates.length &&
                  (S.allowDates = e.extend(!0, [], n.allowDates)),
                n.allowDateRe &&
                  "[object String]" ===
                    Object.prototype.toString.call(n.allowDateRe) &&
                  (S.allowDateRe = new RegExp(n.allowDateRe)),
                n.highlightedDates &&
                ...
                n.disabledDates &&
                  ...
                  (S.disabledDates = e.extend(!0, [], n.disabledDates)),
                n.disabledWeekDays &&
                  e.isArray(n.disabledWeekDays) &&
                  n.disabledWeekDays.length &&
                  (S.disabledWeekDays = e.extend(!0, [], n.disabledWeekDays)),
                (!S.open && !S.opened) || S.inline || t.trigger("open.xdsoft"),
                S.inline &&
                  ((R = !0), O.addClass("xdsoft_inline"), t.after(O).hide()),
                S.inverseButton &&
                  ((S.next = "xdsoft_prev"), (S.prev = "xdsoft_next")),
                S.datepicker ? j.addClass("active") : j.removeClass("active"),
                S.timepicker ? M.addClass("active") : M.removeClass("active"),
                S.value &&
                  (C.setCurrentTime(S.value), t && t.val && t.val(C.str)),
                isNaN(S.dayOfWeekStart)
                  ? (S.dayOfWeekStart = 0)
                  : (S.dayOfWeekStart = parseInt(S.dayOfWeekStart, 10) % 7),
                S.timepickerScrollbar || I.xdsoftScroller(S, "hide"),
                S.minDate &&
                  /^[\+\-](.*)$/.test(S.minDate) &&
                  (S.minDate = i.formatDate(
                    C.strToDateTime(S.minDate),
                    S.formatDate
                  )),
                S.maxDate &&
                  /^[\+\-](.*)$/.test(S.maxDate) &&
                  (S.maxDate = i.formatDate(
                    C.strToDateTime(S.maxDate),
                    S.formatDate
                  )),
                S.minDateTime &&
                  /^\+(.*)$/.test(S.minDateTime) &&
                  (S.minDateTime = C.strToDateTime(S.minDateTime).dateFormat(
                    S.formatDate
                  )),
                S.maxDateTime &&
                  /^\+(.*)$/.test(S.maxDateTime) &&
                  (S.maxDateTime = C.strToDateTime(S.maxDateTime).dateFormat(
                    S.formatDate
                  )),
                L.toggle(S.showApplyButton),
                A.find(".xdsoft_today_button").css(
                  "visibility",
                  S.todayButton ? "visible" : "hidden"
                ),
                A.find("." + S.prev).css(
                  "visibility",
                  S.prevButton ? "visible" : "hidden"
                ),
                A.find("." + S.next).css(
                  "visibility",
                  S.nextButton ? "visible" : "hidden"
                ),
                H(S),
                S.validateOnBlur &&
                  t.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (
                      ...
                      (!e.trim(e(this).val()).length ||
                        ("string" == typeof S.mask &&
                          e.trim(e(this).val()) ===
                            S.mask.replace(/[0-9]/g, "_")))
                    )
            ...
            O.append(j).append(M),
            !0 !== S.withoutCopyright && O.append(P),
            j.append(A).append(E).append(L),
            S.insideParent ? e(t).parent().append(O) : e(S.parentID).append(O),
            (C = new (function () {
              var t = this;
              (t.now = function (e) {
                var i,
                ...
                return (
                  !e &&
                    S.defaultDate &&
                    ((i = t.strToDateTime(S.defaultDate)),
                ...
                (t.strToDateTime = function (e) {
                  ...
                  return e && e instanceof Date && t.isValidDate(e)
                    ? e
                    : ((o = /^([+-]{1})(.*)$/.exec(e)) &&
                        (o[2] = i.parseDate(o[2], S.formatDate)),
                      (s =
                        o && o[2]
                          ? ((n =
                ...
                (t.str = function () {
                  ...
                  return (
                    S.yearOffset &&
                      (e = (e = e.replace(
                        "Y",
                        t.currentTime.getFullYear() + S.yearOffset
                      )).replace(
                        "y",
                        String(
                          t.currentTime.getFullYear() + S.yearOffset
            ...
            A.find(".xdsoft_prev,.xdsoft_next").on(
              ...
              function () {
                ...
                !(function e(s) {
                  t.hasClass(S.next)
                    ? C.nextMonth()
                    : t.hasClass(S.prev) && C.prevMonth(),
                    S.monthChangeSpinner &&
                  ...
                  e([S.ownerDocument.body, S.contentWindow]).on(
                    ...
                    function t() {
                      clearTimeout(i),
                        (n = !0),
                        e([S.ownerDocument.body, S.contentWindow]).off(
                          "touchend mouseup.xdsoft",
                          t
                        );
                    }
              ...
              function () {
                ...
                !(function e(o) {
                  ...
                  t.hasClass(S.next) && a - r - S.timeHeightInTimePicker >= l
                    ? z.css(
                        "marginTop",
                        "-" + (l + S.timeHeightInTimePicker) + "px"
                      )
                    : t.hasClass(S.prev) &&
                      0 <= l - S.timeHeightInTimePicker &&
                      z.css(
                        "marginTop",
                        "-" + (l - S.timeHeightInTimePicker) + "px"
                      ),
              ...
              clearTimeout(o),
                (o = setTimeout(function () {
                  ...
                  for (
                    ...
                    m +=
                      "<th>" +
                      S.i18n[s].dayOfWeekShort[(o + S.dayOfWeekStart) % 7] +
                      "</th>";
                  for (
                    m += "</tr></thead>",
                      m += "<tbody>",
                      !1 !== S.maxDate &&
                        ((b = C.strToDate(S.maxDate)),
                        (b = new Date(
                          b.getFullYear(),
                          b.getMonth(),
                          b.getDate(),
                    ...
                    (T = []),
                      ...
                      T.push("xdsoft_date"),
                      (u =
                        S.beforeShowDay && e.isFunction(S.beforeShowDay.call)
                          ? S.beforeShowDay.call(O, g)
                          : null),
                      S.allowDateRe &&
                        "[object RegExp]" ===
                          Object.prototype.toString.call(S.allowDateRe) &&
                        (S.allowDateRe.test(i.formatDate(g, S.formatDate)) ||
                          T.push("xdsoft_disabled")),
                      S.allowDates &&
                        0 < S.allowDates.length &&
                        -1 ===
                          S.allowDates.indexOf(i.formatDate(g, S.formatDate)) &&
                        T.push("xdsoft_disabled");
                    var P =
                    ...
                    ((!1 !== b && b < g) ||
                      ...
                      T.push("xdsoft_disabled"),
                      -1 !==
                        S.disabledDates.indexOf(
                          i.formatDate(g, S.formatDate)
                        ) && T.push("xdsoft_disabled"),
                      -1 !== S.disabledWeekDays.indexOf(a) &&
                        T.push("xdsoft_disabled"),
                      t.is("[disabled]") && T.push("xdsoft_disabled"),
                      u && "" !== u[1] && T.push(u[1]),
                      C.currentTime.getMonth() !== L &&
                        T.push("xdsoft_other_month"),
                      (S.defaultSelect || O.data("changed")) &&
                        i.formatDate(C.currentTime, S.formatDate) ===
                          i.formatDate(g, S.formatDate) &&
                        T.push("xdsoft_current"),
                      i.formatDate(_, S.formatDate) ===
                        i.formatDate(g, S.formatDate) && T.push("xdsoft_today"),
                      (0 !== g.getDay() &&
                        6 !== g.getDay() &&
                        -1 ===
                          S.weekends.indexOf(i.formatDate(g, S.formatDate))) ||
                        T.push("xdsoft_weekend"),
                      void 0 !==
                        S.highlightedDates[i.formatDate(g, S.formatDate)] &&
                        ((r =
                          S.highlightedDates[i.formatDate(g, S.formatDate)]),
                        T.push(
                          void 0 === r.style
                      ...
                      S.beforeShowDay &&
                        e.isFunction(S.beforeShowDay) &&
                        T.push(S.beforeShowDay(g)),
                      x &&
                        ((m += "<tr>"),
                        (x = !1),
                        S.weeks && (m += "<th>" + d + "</th>")),
                  ...
                  (m += "</tbody></table>"),
                    ...
                    A.find(".xdsoft_label span")
                      .eq(0)
                      .text(S.i18n[s].months[C.currentTime.getMonth()]),
                    A.find(".xdsoft_label span")
                      .eq(1)
                  ...
                  if (!1 !== S.minTime) {
                    ...
                    j = 60 * M.getHours() + M.getMinutes();
                  }
                  var I = 1440;
                  if (
                    (!1 !== S.maxTime &&
                      ((M = C.strtotime(S.maxTime)),
                      (I = 60 * M.getHours() + M.getMinutes())),
                    !1 !== S.minDateTime &&
                      ((M = C.strToDateTime(S.minDateTime)),
                      i.formatDate(C.currentTime, S.formatDate) ===
                        i.formatDate(M, S.formatDate)))
                  ) {
                  ...
                  if (
                    (!1 !== S.maxDateTime &&
                      ((M = C.strToDateTime(S.maxDateTime)),
                      i.formatDate(C.currentTime, S.formatDate) ===
                        i.formatDate(M, S.formatDate) &&
                        (L = 60 * M.getHours() + M.getMinutes()) < I &&
                        (I = L)),
                    (f = function (n, s) {
                      var o,
                        r = C.now(),
                        a =
                          S.allowTimes &&
                          e.isArray(S.allowTimes) &&
                          S.allowTimes.length;
                      r.setHours(n),
                        (n = parseInt(r.getHours(), 10)),
                        r.setMinutes(s),
                        (s = parseInt(r.getMinutes(), 10)),
                        (T = []);
                      var l = 60 * n + s;
                      (t.is("[disabled]") || I <= l || l < j) &&
                        T.push("xdsoft_disabled"),
                        (o = new Date(C.currentTime)).setHours(
                          parseInt(C.currentTime.getHours(), 10)
                        ),
                        a ||
                          o.setMinutes(
                            Math[S.roundTime](
                              C.currentTime.getMinutes() / S.step
                            ) * S.step
                          ),
                        (S.initTime || S.defaultSelect || O.data("changed")) &&
                          o.getHours() === parseInt(n, 10) &&
                          ((!a && 59 < S.step) ||
                            o.getMinutes() === parseInt(s, 10)) &&
                          (S.defaultSelect || O.data("changed")
                            ? T.push("xdsoft_current")
                            : S.initTime && T.push("xdsoft_init_time")),
                        parseInt(_.getHours(), 10) === parseInt(n, 10) &&
                          parseInt(_.getMinutes(), 10) === parseInt(s, 10) &&
                          T.push("xdsoft_today"),
                        (D +=
                    ...
                    for (v = 0; v < S.allowTimes.length; v += 1)
                      f(
                        C.strtotime(S.allowTimes[v]).getHours(),
                        (L = C.strtotime(S.allowTimes[v]).getMinutes())
                      );
                  else
                    for (o = v = 0; v < (S.hours12 ? 12 : 24); v += 1)
                      for (o = 0; o < 60; o += S.step) {
                        var R = 60 * v + o;
                        R < j ||
                          I <= R ||
                          f(
                  ...
                  for (
                    z.html(D), n = "", v = parseInt(S.yearStart, 10);
                    v <= parseInt(S.yearEnd, 10);
                    v += 1
                  )
                    n +=
                      ...
                      "</div>";
                  for (
                    $.children().eq(0).html(n),
                      v = parseInt(S.monthStart, 10),
                      n = "";
                    v <= parseInt(S.monthEnd, 10);
                    v += 1
                  )
                    n +=
                      '<div class="xdsoft_option ' +
                ...
                e
                  ? ((t = I[0].clientHeight),
                    (i = z[0].offsetHeight) - t <
                      (n = z.find(e).index() * S.timeHeightInTimePicker + 1) &&
                      (n = i - t),
                    I.trigger("scroll_element.xdsoft_scroller", [
                      parseInt(n, 10) / (i - t),
                    ]))
            ...
            E.on("touchend click.xdsoft", "td", function (i) {
              ...
              var n = e(this),
                s = C.currentTime;
              if (
                (null == s && ((C.currentTime = C.now()), (s = C.currentTime)),
              ...
              s.setDate(1),
                ...
                O.trigger("select.xdsoft", [s]),
                t.val(C.str()),
                S.onSelectDate &&
                  e.isFunction(S.onSelectDate) &&
                  S.onSelectDate.call(O, C.currentTime, O.data("input"), i),
                O.data("changed", !0),
                O.trigger("xchange.xdsoft"),
                O.trigger("changedatetime.xdsoft"),
                (1 < r ||
                  !0 === S.closeOnDateSelect ||
                  (!1 === S.closeOnDateSelect && !S.timepicker)) &&
                  !S.inline &&
                  O.trigger("close.xdsoft"),
                setTimeout(function () {
                  r = 0;
              ...
              .on("touchend click.xdsoft", "div", function (t) {
                if (!this.touchMoved) {
                  ...
                  n.setHours(i.data("hour")),
                    ...
                    S.onSelectTime &&
                      e.isFunction(S.onSelectTime) &&
                      S.onSelectTime.call(O, C.currentTime, O.data("input"), t),
                    O.data("changed", !0),
                    O.trigger("xchange.xdsoft"),
                    O.trigger("changedatetime.xdsoft"),
                    !0 !== S.inline &&
                      !0 === S.closeOnTimeSelect &&
                      O.trigger("close.xdsoft");
                }
              }),
            ...
            O.on("changedatetime.xdsoft", function (t) {
              if (S.onChangeDateTime && e.isFunction(S.onChangeDateTime)) {
                var i = O.data("input");
                S.onChangeDateTime.call(O, C.currentTime, i, t),
                  delete S.value,
                  i.trigger("change");
              }
            })
              .on("generate.xdsoft", function () {
                S.onGenerate &&
                  e.isFunction(S.onGenerate) &&
                  S.onGenerate.call(O, C.currentTime, O.data("input")),
                  R && (O.trigger("afterOpen.xdsoft"), (R = !1));
              })
            ...
            (l = function () {
              ...
              if (
                ...
                (s = t.left),
                (o = "absolute"),
                (c = e(S.contentWindow).width()),
                (f = e(S.contentWindow).height()),
                (h = e(S.contentWindow).scrollTop()),
                S.ownerDocument.documentElement.clientWidth - t.left <
                  j.parent().outerWidth(!0))
              ) {
                var p = j.parent().outerWidth(!0) - i.offsetWidth;
                s -= p;
              }
              "rtl" === l.parent().css("direction") &&
                (s -= O.outerWidth() - l.outerWidth()),
                S.fixed
                  ? ((n -= h),
                    (s -= e(S.contentWindow).scrollLeft()),
                    (o = "fixed"))
                  : ((a = !1),
                    D(i, function (e) {
                      return (
                    ...
                    a && !S.insideParent
                      ? ((o = "fixed"),
                        n + O.outerHeight() > f + h
                          ? ((d = "bottom"), (n = f + h - t.top))
                          : (n -= h))
                      : n + O[0].offsetHeight > f + h &&
                        (n = t.top - O[0].offsetHeight + 1),
                    n < 0 && (n = 0),
                    s + i.offsetWidth > c && (s = c - i.offsetWidth)),
                (r = O[0]),
                D(r, function (e) {
                  if (
                    "relative" ===
                    ...
                    return (s -= (c - e.offsetWidth) / 2), !1;
                }),
                (u = {
                  position: o,
                  left: S.insideParent ? i.offsetLeft : s,
                  top: "",
                  bottom: "",
                }),
                S.insideParent
                  ? (u[d] = i.offsetTop + i.offsetHeight)
                  : (u[d] = n),
                O.css(u);
            }),
            O.on("open.xdsoft", function (t) {
              var i = !0;
              S.onShow &&
                e.isFunction(S.onShow) &&
                (i = S.onShow.call(O, C.currentTime, O.data("input"), t)),
                !1 !== i &&
                  (O.show(),
                  l(),
                  e(S.contentWindow)
              ...
              .on("close.xdsoft", function (t) {
                ...
                A.find(".xdsoft_month,.xdsoft_year")
                  ...
                  .hide(),
                  S.onClose &&
                    e.isFunction(S.onClose) &&
                    (i = S.onClose.call(O, C.currentTime, O.data("input"), t)),
                  !1 === i || S.opened || S.inline || O.hide(),
                  t.stopPropagation();
              })
        ...
        (a = function (t) {
          ...
          i &&
            ...
            e([S.contentWindow, S.ownerDocument.body]).off(
                  ...
                  (this.value = this.defaultValue),
                    (this.value &&
                      s
                        ...
                        .isValidDate(i.parseDate(this.value, S.format))) ||
                      s.data("changed", !1),
...
!(function (e) {
  ...
  (function (e) {
    ...
    function l(n) {
      ...
      if (
        ...
        if (
          ((s = Math.max(Math.abs(h), Math.abs(f))),
          (!i || s < i) && d(r, (i = s)) && (i /= 40),
          d(r, s) && ((u /= 40), (f /= 40), (h /= 40)),
          ...
          (p = n.clientX - _.left), (m = n.clientY - _.top);
        }
        return (
          (n.deltaX = f),
          (n.deltaY = h),
        ...
        getInline: function (i, n) {
          if ((P(), i.src)) {
            ...
            if (o.length) {
              ...
              r &&
                r.tagName &&
                (C || ((S = s.hiddenClass), (C = k(S)), (S = "mfp-" + S)),
                (D = o.after(C).detach().removeClass(S))),
          ...
          return (
            ...
            !(!i || !i.enabled) &&
              ...
              y("UpdateStatus" + s, function (e, i) {
                i.text &&
                  (i.text = N(i.text, t.currItem.index, t.items.length));
              }),
              y(c + s, function (e, n, s, o) {
                var r = t.items.length;
                s.counter = r > 1 ? N(i.tCounter, o.index, r) : "";
              }),
        ...
        initRetina: function () {
          if (window.devicePixelRatio > 1) {
            var e = t.st.retina,
              i = e.ratio;
            (i = isNaN(i) ? i() : i) > 1 &&
              (y("ImageHasSize." + W, function (e, t) {
                t.img.css({
                  "max-width": t.img[0].naturalWidth / i,
                  width: "100%",
                });
              }),
              y("ElementParse." + W, function (t, n) {
  ...
  function () {
    ...
    !(function (e, t) {
      ...
      var s, o, r, a, l, c, d, u, f, h, p, m, g, v, _, b;
      return (
        (s = i(n)),
        (u = e.call(n, "ontouchstart") >= 0),
          ...
          return (
            (e.prototype.doScroll = function () {
              ...
              return (
                ...
                !u ||
                  (e.vertical.oldScroll && e.vertical.newScroll) ||
                  i[b]("refresh"),
                i.each(e, function (e, n) {
                  ...
                  return (
                    ...
                    i.each(t.waypoints[e], function (e, t) {
                      var i, s;
                      return (n.oldScroll < (i = t.offset) &&
                        i <= n.newScroll) ||
                        (n.newScroll < (s = t.offset) && s <= n.oldScroll)
                        ? r.push(t)
                        : void 0;
                    }),
                    r.sort(function (e, t) {
                    ...
                    i.each(r, function (e, t) {
                      if (t.options.continuous || e === r.length - 1)
                        return t.trigger([s]);
                    })
                  );
                }),
                ...
                i.each(e, function (e, t) {
                  return i.each(s.waypoints[e], function (e, n) {
                    ...
                    if (
                      ((s = n.options.offset),
                      (r = n.offset),
                      (o = i.isWindow(n.element)
                        ? 0
                        : n.$element.offset()[t.offsetProp]),
                      i.isFunction(s)
                        ? (s = s.apply(n.element))
                        : "string" == typeof s &&
                          ((s = parseFloat(s)),
                          n.options.offset.indexOf("%") > -1 &&
                            (s = Math.ceil((t.contextDimension * s) / 100))),
                      (n.offset = o - t.contextOffset + t.contextScroll - s),
            ...
            (e.prototype.checkEmpty = function () {
              if (
                ...
                return (
                  this.$element.unbind([p, m].join(" ")), delete d[this.id]
                );
            }),
            e
          );
        ...
        (r = (function () {
          function e(e, t, n) {
            var s, o;
            "bottom-in-view" ===
              (n = i.extend({}, i.fn[_].defaults, n)).offset &&
              (n.offset = function () {
                var e;
                return (
                  (e = i[b]("viewportHeight")),
                  i.isWindow(t.element) || (e = t.$element.height()),
              ...
              (s = null != (o = e.data(v)) ? o : []).push(this.id),
              e.data(v, s);
          }
          return (
            ...
            (e.getWaypointsByElement = function (e) {
              var t, n;
              return (n = i(e).data(v))
                ? ((t = i.extend({}, a.horizontal, a.vertical)),
                  i.map(n, function (e) {
                    return t[e];
                  }))
                : [];
          ...
          init: function (e, t) {
            return (
              ...
              this.each(function () {
                ...
                return (
                  (e = i(this)),
                  (s = null != (a = t.context) ? a : i.fn[_].defaults.context),
                  i.isWindow(s) || (s = e.closest(s)),
                  (s = i(s)),
                  (n = d[s.data(c)]) || (n = new o(s)),
                  new r(e, n, t)
                );
              }),
              i[b]("refresh"),
        ...
        (f = {
          ...
          aggregate: function (e) {
            ...
            return (
              (t = a),
              e && (t = null != (s = d[i(e).data(c)]) ? s.waypoints : void 0),
              t
          ...
          above: function (e) {
            return (
              null == e && (e = n),
              f._filter(e, "vertical", function (e, t) {
          ...
          left: function (e) {
            return (
              null == e && (e = n),
              f._filter(e, "horizontal", function (e, t) {
          ...
          _invoke: function (e) {
            var t;
            return (
              (t = i.extend({}, a.vertical, a.horizontal)),
          ...
          _filter: function (e, t, n) {
            var s, o;
            return (s = d[i(e).data(c)])
              ? ((o = []),
                i.each(s.waypoints[t], function (e, t) {
        ...
        (i[b] = function () {
          ...
          return (
            (i = arguments[0]),
            (e = 2 <= arguments.length ? t.call(arguments, 1) : []),
            f[i] ? f[i].apply(null, e) : f.aggregate.call(null, i)
          );
        }),
        (i[b].settings = { resizeThrottle: 100, scrollThrottle: 30 }),
        s.load(function () {
          return i[b]("refresh");
        })
      );
